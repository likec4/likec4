...
This release has breaking changes in `@likec4/diagrams`.  
We do not do major release yet, as project still in active development.
...
Updating [documentaion](https://www.likec4.dev/docs/tools/react/)...

### Features

- **diagrams:** react component LikeC4Browser ([2cd5387](https://github.com/likec4/likec4/commit/2cd5387cb21b4fac48f574783045a2fec554b8e2))
