...
The original DrawIO bidirectional work (branch `feat/drawio-bidirectional-playground`) was reviewed upstream in [likec4/likec4 PR #2593](https://github.com/likec4/likec4/pull/2593). This export-only PR is a split from that work; CodeRabbit AI review comments have been addressed in the "Post-review fixes" section above.
