...
The `specification` statement customizes your architecture model.

## Element

`element` statement defines the kind, the can be used in the model.
...
Kind definition may have a `style` statement - defaults for all elements of this kind.
