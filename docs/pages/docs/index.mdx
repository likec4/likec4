...
- With [github.dev](https://github.dev/likec4/example-cloud-system/blob/main/model.c4) (install recommended extension)
- With [vscode.dev](https://vscode.dev/github/likec4/example-cloud-system/blob/main/model.c4) (install recommended extension)
...
Imagine, we zoom-in and expand the `saas` element, we see nested elements and their relationships:
