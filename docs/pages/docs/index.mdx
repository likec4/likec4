...
You can play with [this tutorial in playground](/playground/getting-started/), for example, try to change the [shape](/docs/dsl/specification/#shapes) of the `customer` element.
