...
We add new kind to the specification - `component` and update the model.
...
```likec4 showLineNumbers {13,14,17-18} filename="getting-started.c4" 
specification {
  element actor
  element system
  element component
...
And if we change the model - views are updated automatically.
...
We changed description of the element and label of the relationship.  
Landscape view:
...
Or you can try [this tutorial in playground](/playground/getting-started/).
