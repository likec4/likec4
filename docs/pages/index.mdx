...
LikeC4 source ([full](https://github.com/likec4/likec4/blob/main/docs/likec4/index-page/index-page.c4)):

```likec4
specification { // define "types" of architecture elements
  element actor {
    style {
      shape person // how to render this element
    }
  }
  element system
}
...
views { // what to present from the model
  view index {
    include * // predicate to include all elements
  }
}
```
