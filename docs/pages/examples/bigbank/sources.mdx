...
<Tabs items={['specification', 'model and views']}>
  <Tab>

    Defines allowed element types and their styles.

    [open on github](https://github.com/likec4/likec4/blob/main/docs/likec4/_spec.c4)

    ```js filename="specification.c4"
    specification {
  ...
  <Tab>
    ...
    Defines architecture model, elements, composition and relationships and views.

    [open on github](https://github.com/likec4/likec4/blob/main/docs/likec4/bigbank.c4)

    ```js filename="bigbank.c4"
    model {
