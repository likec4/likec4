...
const icons = globSync(`../../packages/icons/src/*/*.tsx`).map(path => {
...
writeFileSync('src/icons.gen.tsx', toString(out), 'utf-8')

console.log(`Generated src/icons.gen.tsx with ${icons.length} icons`)
