...
export const setActiveEditor = (filename) => {
...
export function cleanDisposables(disposables) {
...
export function createMemoryFileSystem(fsProvider, files, activeFilename) {
 ...
 */
export function ensureFileInWorkspace(fsProvider, filename, content) {
