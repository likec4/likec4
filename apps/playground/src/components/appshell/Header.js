...
export function Header() {
    ...
    return (<Group h="100%" px="md" justify="space-between" align="stretch">
      ...
      <Group h="100%" gap={'xs'}>
        ...
        <PlaygroundsMenu />
        <Button component="a" href="https://likec4.dev/tutorial/" target="_blank" variant="subtle" px={'xs'} size="xs" visibleFrom="sm" color="gray">
          Docs
        </Button>
        <Button component="a" href="https://github.com/likec4/likec4" target="_blank" variant="subtle" px={'xs'} size="xs" visibleFrom="md" color="gray">
          GitHub
        </Button>
        <ColorSchemeToggle />
        <UserButton />
