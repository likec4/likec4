...
This approach makes it easy to enforce custom constraints and validate your model directly in tests.  
Running these checks in your CI pipeline is fast, type-safe, and provides immediate feedback when the model breaks your rules.
