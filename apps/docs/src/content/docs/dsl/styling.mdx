...
When using SVGs, you can bake the light and dark mode's into a single file and use a `prefers-color-scheme` media query to switch between them.
...
![Example of an icon with light and dark mode baked in](../../../assets/logo.svg)
:::
