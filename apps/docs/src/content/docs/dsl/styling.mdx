...
When shape size is `small` or `xsmall`, only element's title is displayed.
...
Refer to [Graphviz arrowType](https://graphviz.org/docs/attr-types/arrowType/) for visuals.import LikeC4ThemeView from '@components/likec4-theme/LikeC4ThemeView.astro';
import { Aside } from '@astrojs/starlight/components';
import { Aside } from '@astrojs/starlight/components';
import LikeC4ThemeView from '@components/likec4-theme/LikeC4ThemeView.astro';import LikeC4ThemeView from '@components/likec4-theme/LikeC4ThemeView.astro';
import { Aside } from '@astrojs/starlight/components';
import { Aside } from '@astrojs/starlight/components';
import LikeC4ThemeView from '@components/likec4-theme/LikeC4ThemeView.astro';
