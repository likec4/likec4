...
To add additional notes to the view and/or clarify steps, use `notes` property.  
Notes are displayed during walk-through and in the diagram.
...
<DynamicLikeC4View viewId="parallel-example"/>
