---
title: Model
description: How to define architecture elements and their relationships in LikeC4
sidebar: 
  label: Model
  order: 3
tableOfContents:
...
```import type { technology } from '../../../../../../packages/diagram/src/xyflow/nodes/element/element.css';
