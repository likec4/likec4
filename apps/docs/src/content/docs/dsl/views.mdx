...
view apiApp of internetBankingSystem.apiApplication {
  ...
  // apply apiApplication and nested
...
```* as componentscomponents.AsideAside: components.Asidecomponents.TabItemTabItem: components.TabItemcomponents.TabsTabs: components.Tabscomponents.Asidecomponents.Asidecomponents.Asidecomponents.Asidecomponents.Asidecomponents.Asidecomponents.Asidecomponents.Aside
