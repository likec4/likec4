...
###### Custom navigation :badge[v1.10]{variant="success"}

To stricly define navigation from relation use `navigateTo`.   
For relationships, it is possible to navigate to [dynamic views](/dsl/dynamic-views) only:
