...
description: LikeC4 version of the Big Bank plc example by Simon Brown, based around a fictional online banking system.
sidebar:
  label: Big Bank plc
  order: 2
tableOfContents:
...
import { Aside, Tabs, TabItem as Tab, LinkCard, CardGrid } from '@astrojs/starlight/components';
