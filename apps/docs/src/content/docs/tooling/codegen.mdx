...
This command generates a JavaScript file (and type definitions `.d.ts`) with React component:
...
Keep in mind that `where` applies to elements and to relationships.
