...
You can initiate Model API from a directory with source files or from a string with DSL source.
...
Method also accepts optional properties:

| Property         | Description                                                                                         |
| -----------------| --------------------------------------------------------------------------------------------------- |
| `throwIfInvalid` | boolean, If true, initialization will return rejected promise (default `false`) |
| `logger`         | Whenever to use `vite` logger, `default` (console) or custom implementation  |
