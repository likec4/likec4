...
For mapping details, limitations, and multi-diagram behavior, see [Draw.io integration](/tooling/drawio).
...
Together with [Export to DrawIO](#export-to-drawio) and [Import from DrawIO](#import-from-drawio), this allows teams to reuse diagrams in Mermaid, Dot, D2, PlantUML, or DrawIO.
