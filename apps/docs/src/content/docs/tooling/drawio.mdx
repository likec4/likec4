...
| Element: border, opacity | Style `strokeWidth`, `likec4Border`; `opacity` |
...
| Vertex: likec4* style keys | Element: description, technology, notes, tags, navigateTo, icon, summary, links, notation, border, opacity, shape |
