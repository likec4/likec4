...
exports.elementShapeRecipe = void 0;
...
exports.elementShapeRecipe = (0, dev_1.defineRecipe)({
    ...
    base: parts({
        root: (_a = {
            ...
            _a[const_ts_1.vars.palette.outline] = {
                base: "oklch(from ".concat((0, const_ts_1.__v)('palette.stroke'), " calc(l * 0.9) c h)"),
                _dark: "oklch(from ".concat((0, const_ts_1.__v)('palette.stroke'), " calc(l * 1.2) calc(c * 1.05) h)"),
            },
            _a['--likec4-outline-size'] = "4px",
            _a),
        outline: {
            opacity: 0.8,
