...
export declare const setViewport: (params?: {
    viewport: Viewport;
    duration?: number;
...
export declare const setViewportCenter: (params?: {
    x: number;
    y: number;
}) => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, unknown, import("xstate").Values<{
    hotkeyActorLogic: {
...
export declare const centerOnNodeOrEdge: () => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, undefined, never, never, never, never, never>;
...
export declare const fitFocusedBounds: () => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, unknown, import("xstate").Values<{
    hotkeyActorLogic: {
        src: "hotkeyActorLogic";
        logic: import("./hotkeyActor").HotkeyActorLogic;
        id: "hotkey";
...
export declare const raiseSetViewport: (params: {
    delay?: number;
    duration?: number;
    viewport: Viewport;
}) => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, undefined, never, never, never, never, never>;
export declare const cancelFitDiagram: () => import("xstate").CancelAction<import("./machine.setup").Context, import("./machine.setup").Events, undefined, import("./machine.setup").Events>;
export declare const raiseFitDiagram: (params?: {
    delay?: number;
    duration?: number;
    bounds?: BBox;
}) => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, undefined, never, never, never, never, never>;
export declare const raiseUpdateView: (view?: DiagramView) => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, undefined, never, never, never, never, never>;
export declare const assignViewportBefore: (viewport?: Viewport | false) => import("xstate").ActionFunction<import("./machine.setup").Context, import("./machine.setup").Events, import("./machine.setup").Events, undefined, import("xstate").Values<{
    hotkeyActorLogic: {
        src: "hotkeyActorLogic";
        logic: import("./hotkeyActor").HotkeyActorLogic;
        id: "hotkey";
...
export declare const returnViewportBefore: (params?: {
    delay?: number;
    duration?: number;
