...
import type { DiagramEdge, DiagramNode, DynamicViewDisplayVariant, LayoutedView, LayoutType, WhereOperator } from '@likec4/core/types';
...
export type OnNavigateTo<A extends Any = Unknown> = (to: ViewId<A>, event?: ReactMouseEvent, element?: DiagramNodeWithNavigate<A>) => void;
export type OnNodeClick<A extends Any = Unknown> = (node: DiagramNode<A>, event: ReactMouseEvent) => void;
export type OnEdgeClick<A extends Any = Unknown> = (edge: DiagramEdge<A>, event: ReactMouseEvent) => void;
/**
