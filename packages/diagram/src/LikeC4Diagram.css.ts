...
export const cssReactFlow = css({
  ...
  // ['--xy-edge-label-color']: '{colors.xyedge.label}',
  // ['--xy-edge-label-background-color']: '{colors.xyedge.label.bg}',
...
// })
// })
export const cssDisablePan = css({})

export const cssTransparentBg = css({
