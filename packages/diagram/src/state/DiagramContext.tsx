...
import { type PropsWithChildren, createContext, useCallback, useEffect, useRef } from 'react'
import { clone } from 'remeda'
import { useUpdateEffect } from '../hooks/useUpdateEffect'
import { useXYFlow, useXYStoreApi } from '../hooks/useXYFlow'
import { type DiagramInitialState, type DiagramZustandStore, createDiagramStore } from './diagramStore'
...
export function DiagramContextProvider({
  ...
  const store = useRef<DiagramZustandStore>(undefined)
