 ...
 * ```
 */
export declare function elementNode<A extends Any = Unknown>(component: FC<ElementNodeProps<A>>): Types.NodeRenderer<'element'>;
 ...
 * ```
 */
export declare function deploymentNode<A extends Any = Unknown>(component: FC<DeploymentNodeProps<A>>): Types.NodeRenderer<'deployment'>;
 ...
 * ```
 */
export declare function compoundElementNode<A extends Any = Unknown>(component: FC<CompoundElementNodeProps<A>>): Types.NodeRenderer<'compound-element'>;
 ...
 * ```
 */
export declare function compoundDeploymentNode<A extends Any = Unknown>(component: FC<CompoundDeploymentNodeProps<A>>): Types.NodeRenderer<'compound-deployment'>;
 ...
 * ```
 */
export declare function viewGroupNode<A extends Any = Unknown>(component: FC<ViewGroupNodeProps<A>>): Types.NodeRenderer<'view-group'>;
export type ViewGroupNodeProps<A extends Any = Unknown> = {
    nodeProps: Types.NodeProps<'view-group'>;
    nodeModel: NodeModel.IsGroup<A>;
};
export declare function sequenceActorNode<A extends Any = Unknown>(component: FC<SequenceActorNodeProps<A>>): Types.NodeRenderer<'seq-actor'>;
