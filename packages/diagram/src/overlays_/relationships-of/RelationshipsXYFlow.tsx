import { type AbstractRelation, type DiagramView, type Fqn, delay, isAncestor } from '@likec4/core'
...
const resetDimmedAndHovered = (
  xyflow: ReactFlowInstance<RelationshipsOfFlowTypes.Node, RelationshipsOfFlowTypes.Edge>,
) => {
...
const animateEdge =
  (node: RelationshipsOfFlowTypes.Node, animated = true) => (edges: RelationshipsOfFlowTypes.Edge[]) => {
