...
describe('formating', () => {
    describe('formats imports', () => {
        it('formats import rules', async ({ expect }) => expect(await format `
    ...
    describe('formats specification', () => {
        it('formats specification rules', async ({ expect }) => expect(await format `
          specification{
            element     el
      ...
      `));
        it('formats styles in specification rules', async ({ expect }) => expect(await format `
          specification{
    ...
    describe('formats globals', () => {
        it('formats syles and styleGroups', async ({ expect }) => expect(await format `
          global{
        ...
        `));
        it('formats predicate groups', async ({ expect }) => expect(await format `
          global{
    ...
    describe('formats model', () => {
        it('formats element', async ({ expect }) => expect(await format `
        model {
          system    sys1
      ...
      `));
        it('formats element extend', async ({ expect }) => expect(await format `
          model {
            extend    sys1.sys2   {
              #tag1   ,   #tag2
        ...
        `));
        it('formats metadata', async ({ expect }) => expect(await format `
          model {
            system sys1 {
              metadata {
                prop1    'some'
        ...
        `));
        it('separates element kind and name with space', async ({ expect }) => expect(await format `
          specification {
            element el
          }
          model {
    ...
    describe('formats deployments', () => {
        it('formats node declarations', async ({ expect }) => expect(await format `
          deployment{
          node   zone1    {
          instanceOf test
          }
        ...
        `));
        it('formats deployment extends', async ({ expect }) => expect(await format `
          deployment{
          extend   zone1    {
          #tag1 ,  #tag2
          link   http://example.com    'extended link'
        ...
        `));
        it('formats instance declarations', async ({ expect }) => expect(await format `
          deployment{
          node   zone1    {
          instanceOf    test
          instanceOf test2{
        ...
        `));
        it('surrounds arrows with space', async ({ expect }) => expect(await format `
          specification {
            element component
            relationship http
            deploymentNode node
    ...
    describe('formats views', () => {
        it('formats include/exclude expressions', async ({ expect }) => expect(await format `
          specification {
            element el
            deploymentNode node
          }
      ...
      `);
        ...
        it('formats where expression', async ({ expect }) => expect(await format `
          views {
            view index {
      ...
      `));
        it('formats where expression v2', async ({ expect }) => expect(await format `
          views {
            deployment view index {
              include * where    tag==#tag1
                 or(tag!=#tag1   and   kind    is   not    kind1)
      ...
      `));
        it('formats global style references', async ({ expect }) => expect(await format `
          views {
          view {
        ...
        `));
        it('formats global predicate references', async ({ expect }) => expect(await format `
          views {
          view {
        ...
        `));
        it('formats styles', async ({ expect }) => expect(await format `
          views {
            view {
              style   *  ,sys1   ,   sys2 {
              }
        ...
        `));
        it('formats view declarations', async ({ expect }) => expect(await format `
          views {
            view    index{
            }
            view{
        ...
        `));
        it('formats with predicates', async ({ expect }) => expect(await format `
          views {
            view {
              include    *  with{   }
        ...
        `));
        it('formats autolayout property', async ({ expect }) => expect(await format `
          views {
            view {
        ...
        `));
        it('formats groups', async ({ expect }) => expect(await format `
          views {
            view {
          group   "group1"{
          color    red
        ...
        `));
        it('formats chained dynamic steps', async ({ expect }) => await expect(format `
        views {dynamic
        view index {
        A ->  B {    title   'ab...'   }    -> C    'cd...'
        }
        ...
        `));
        it('formats multiline chained dynamic steps', async ({ expect }) => await expect(format `
        views {
        dynamic view index {
        AAA ->  BBB { line solid
        } -[uses]->
        ...
        `));
        it('formats multiline and parallel chained dynamic steps', async ({ expect }) => await expect(format `
        views {
        dynamic view index {
        AAA ->  BBB { line solid
        } ->
    ...
    describe('common formatting', () => {
        it('indents', async ({ expect }) => expect(await format `
          views {
          view index {
          include *
          style user {
      ...
      `));
        it('prepends open braces with space', async ({ expect }) => expect(await format `
          views{
            view index   {
              include *
            }
      ...
      `));
        it('handles comments', async ({ expect }) => expect(await format `
          specification {
                // comment
                // comment2
                // comment3
        ...
        `));
        it('formats tags', async ({ expect }) => expect(await format `
          model {
            system sys1 {
      ...
      `));
        it('puts tags on a new line', async ({ expect }) => expect(await format `
          specification {
            element el
            tag tag1
            tag tag2
      ...
      `));
        it('formats link property', async ({ expect }) => expect(await format `
          model {
            system sys1 {
        ...
        `));
        it('formats navigateTo property', async ({ expect }) => expect(await format `
          views {
            view {
              include
                * with {
        ...
        `));
        it('formats style leaf properties', async ({ expect }) => expect(await format `
          specification {
            element system {
              style {
                color primary
        ...
        `));
        it('formats leaf properties with colon', async ({ expect }) => expect(await format `
          specification {
            element system {
              notation  :    'test'   ;
              technology  :  'test'   ;
        ...
        `));
        it('formats style leaf properties with colon', async ({ expect }) => expect(await format `
          specification {
            element system {
              style {
                color  : primary   ;
        ...
        `));
        it('formats leaf properties', async ({ expect }) => expect(await format `
          specification {
            element system {
              notation    'test'
              technology  'test'
        ...
        `));
        it('prepends props with space', async ({ expect }) => expect(await format `
          model {
        ...
        `));
        it('prepends properties with new line', async ({ expect }) => expect(await format `
          specification {
            element component
          }
          model {
        ...
        `));
        it('preserves empty lines', async ({ expect }) => expect(await format `
          model {
        ...
        `));
        it('normalize quotes', async ({ expect }) => expect(await format `
          model {
            component user "some title" "description"
            component user2 {
              description "some"
        ...
        `));
        it('keeps internal quotes', async ({ expect }) => expect(await format `
          model {
