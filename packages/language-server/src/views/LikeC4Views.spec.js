...
describe('LikeC4Views', () => {
    ...
    `);
        ...
        const diagrams1 = await services.likec4.Views.diagrams().then(d => indexBy(d, v => v.id));
        // add model
        await parse(`
      model {
        component sys3
    ...
    `);
        ...
        const diagrams2 = await services.likec4.Views.diagrams().then(d => indexBy(d, v => v.id));
