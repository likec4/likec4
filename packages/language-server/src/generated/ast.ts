...
export function isSpecificationElementKindStyle(
  item: unknown
): item is SpecificationElementKindStyle {
  ...
  getTypeMetaData(type: string): TypeMetaData {
    switch (type) {
      case 'Element': {
        return {
          name: 'Element',
          mandatory: [{ name: 'props', type: 'array' }]
        }
      }
      case 'ElementBody': {
        return {
      ...
      case 'ElementRefExpression': {
        return {
          ...
          mandatory: [{ name: 'isDescedants', type: 'boolean' }]
        }
      }
      case 'ElementStyleProperty': {
        return {
      ...
      case 'ModelViews': {
        return {
          name: 'ModelViews',
          mandatory: [{ name: 'views', type: 'array' }]
        }
      }
      case 'RelationBody': {
        return {
      ...
      case 'WildcardExpression': {
        return {
          ...
          mandatory: [{ name: 'isWildcard', type: 'boolean' }]
        }
      }
      default: {
        return {
