...
describe('parseIconProperty', () => {
    ...
    `);
        ...
        expect(model.element('comp2').icon).toBe('file:///testing/nested/image-alias/workspace/src/../../assets/images/icons/custom.svg');
    });
    ...
    `);
        ...
        // inside the provided workspace, so the expectations
        // account for the extra folder.
        expect(model.element('comp1').icon).toBe('file:///testing/nested/image-alias/workspace/src/../asset-images/logo.svg');
        expect(model.element('comp2').icon).toBe('file:///testing/nested/image-alias/workspace/src/../../assets/images/icons/custom.svg');
    });
