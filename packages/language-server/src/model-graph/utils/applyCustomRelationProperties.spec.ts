import type { ComputedEdge, ComputedNode, CustomRelationExpr, ViewID, ViewRule } from '@likec4/core'
import { describe, expect, it } from 'vitest'
import { $include, $inout, $where } from '../compute-view/__test__/fixture'
