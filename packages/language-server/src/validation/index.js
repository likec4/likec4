...
import { colorLiteralRuleChecks, iconPropertyRuleChecks, opacityPropertyRuleChecks, } from './property-checks';
...
const isValidatableAstNode = isAnyOf(ast.isImportsFromPoject, ast.isImported, ast.isGlobals, ast.isGlobalPredicateGroup, ast.isGlobalDynamicPredicateGroup, ast.isGlobalStyle, ast.isGlobalStyleGroup, ast.isFqnExprWith, ast.isRelationExprWith, ast.isFqnExpr, ast.isRelationExpr, ast.isDynamicViewParallelSteps, ast.isDynamicStepChain, ast.isDynamicStepSingle, ast.isDeploymentViewRule, ast.isDeploymentViewRulePredicate, ast.isExpressionV2, ast.isRelationExpr, ast.isFqnRefExpr, ast.isViewProperty, ast.isStyleProperty, ast.isTags, ast.isViewRule, ast.isDynamicViewRule, ast.isLikeC4View, ast.isViewRuleStyleOrGlobalRef, ast.isDeployedInstance, ast.isDeploymentNode, ast.isDeploymentRelation, ast.isRelationshipStyleProperty, ast.isDynamicViewDisplayVariantProperty, ast.isMetadataBody, ast.isMetadataProperty, ast.isRelation, ast.isRelationBody, ast.isElementProperty, ast.isStringProperty, ast.isNavigateToProperty, ast.isElement, ast.isElementBody, ast.isElementStyleProperty, ast.isElementRef, ast.isExtendElement, ast.isExtendElementBody, ast.isExtendDeployment, ast.isExtendDeploymentBody, ast.isExtendRelation, ast.isExtendRelationBody, ast.isSpecificationElementKind, ast.isSpecificationRelationshipKind, ast.isSpecificationDeploymentNodeKind, ast.isSpecificationTag, ast.isSpecificationColor, ast.isSpecificationRule, ast.isExpressions, ast.isColorLiteral);
