...
const SvgGkeOnPrem = (props: SVGProps<SVGSVGElement>) => {
...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <path
      ...
      fill="#aecbfa"
    />
    <path d="M16.96 8.63 12.1 5.78 7.13 8.63l4.97 2.77z" data-name="Path" fill="#669df6" />
    <path d="M12.1 12.38 6.84 9.32v2.47l5.26 2.96zM12.1 15.73l-5.26-3.05v2.07l5.26 3.06z" fill="#669df6" />
    <path
