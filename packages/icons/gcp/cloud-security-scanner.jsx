 ...
 */
const SvgCloudSecurityScanner = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <path
      ...
      fill="#aecbfa"
    />
    <path d="M14.46 20.42a2 2 0 1 1 0-3.93" fill="#669df6" />
    <path d="M14.46 16.49a2 2 0 1 1 0 3.93" fill="#4285f4" />
    <path d="M19.38 8.1a1.34 1.34 0 0 1 0-2.67v-1a2.38 2.38 0 0 0 0 4.75Z" fill="#669df6" />
    <path d="M19.38 5.43a1.34 1.34 0 0 1 0 2.67v1a2.38 2.38 0 0 0 0-4.75Z" fill="#4285f4" />
