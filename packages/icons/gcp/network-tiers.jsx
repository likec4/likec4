  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <path
        ...
        className="cls-1"
      />
      <circle id="Oval-2" cx={8} cy={19} r={2} className="cls-2" />
      <circle id="Oval-2-2" cx={19} cy={16} r={2} className="cls-3" data-name="Oval-2" />
      <circle id="Oval-2-3" cx={14} cy={20} r={2} className="cls-1" data-name="Oval-2" />
      <path d="M6 12H2a10 10 0 0 0 .44 2.91l4-.79A6 6 0 0 1 6 12" className="cls-3" />
      <g data-name="colored-32/network-tiers">
        <circle id="Oval-2-4" cx={5} cy={8} r={2} className="cls-2" data-name="Oval-2" />
      </g>
