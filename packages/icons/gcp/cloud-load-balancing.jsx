 ...
 */
const SvgCloudLoadBalancing = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <g data-name="colored-32/load-balancing">
        ...
        <path d="M16 16h6v6h-6zM2 16h6v6H2z" className="cls-4" />
        <path d="M5 16h3v6H5z" className="cls-2" />
        <path d="M9 16h6v6H9z" className="cls-4" />
        <path d="M12 16h3v6h-3zM19 16h3v6h-3z" className="cls-2" />
      </g>
    </g>
  </svg>
)
