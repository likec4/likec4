...
const SvgCloudOptimizationAiFleetRoutingApi = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    xmlSpace="preserve"
    id="Cloud-Optimization-AI---Fleet-Routing-API_svg__Artwork"
    x={0}
    y={0}
    viewBox="0 0 24 24"
    {...props}
  >
    <style>
      {'.Cloud-Optimization-AI---Fleet-Routing-API_svg__st0{fill:#aecbfa}.Cloud-Optimization-AI---Fleet-Routing-API_svg__st1{fill:#4285f4}'}
    </style>
    <path
      ...
      className="Cloud-Optimization-AI---Fleet-Routing-API_svg__st0"
    />
    <path
      ...
      className="Cloud-Optimization-AI---Fleet-Routing-API_svg__st1"
    />
  </svg>
)
