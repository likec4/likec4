  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <g data-name="colored-32/dns">
        <path id="Fill-1" d="M13 18h-2V8h2z" fill="#4285f4" />
        <path id="Fill-2" d="M2 21h20v-2H2z" className="cls-2" />
        <path id="Fill-3" d="M10 22h4v-4h-4z" className="cls-3" />
      </g>
