  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <g data-name="colored-32/profiler">
        ...
        <circle id="Oval" cx={12} cy={14} r={4} className="cls-1" />
        <path id="Oval-2" d="M12 18a4 4 0 1 0 0-8v4l-3.27 2.32A4 4 0 0 0 12 18" data-name="Oval" fill="#aecbfa" />
