...
const SvgGenomics = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      ...
      <path d="m9.36 15.5.74.7h6.28v-1.4H10.1z" className="cls-2" />
      <circle cx={6.8} cy={15.5} r={1.6} className="cls-1" />
      <circle cx={17.2} cy={15.5} r={1.23} className="cls-3" />
      <path d="M4.18 5h12.68l.74-.7-.74-.7H4.18z" className="cls-2" />
      <circle cx={3.6} cy={4.3} r={1.23} className="cls-3" />
      <circle cx={20.4} cy={4.3} r={1.6} className="cls-1" />
      <path d="m6.4 19.7.74.7h12.7V19H7.14z" className="cls-2" />
      <circle cx={3.6} cy={19.7} r={1.6} className="cls-1" />
