...
const SvgCloudHealthcareApi = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <defs>
      <style>{'.Cloud-Healthcare-API_svg__cls-4{fill:#4285f4}.Cloud-Healthcare-API_svg__cls-6{fill:#669df6}'}</style>
      <mask
        id="Cloud-Healthcare-API_svg__mask"
        width={5.33}
        height={16.67}
        x={9.33}
        y={5.33}
      ...
      >
        <path
          id="Cloud-Healthcare-API_svg__path-1"
    ...
    <g data-name="Product Icons">
      ...
      <path
        ...
        className="Cloud-Healthcare-API_svg__cls-4"
        mask="url(#Cloud-Healthcare-API_svg__mask)"
      />
      <path
        id="Cloud-Healthcare-API_svg__Line-2"
        d="M12.83 18.87h-1.66v-1.54h1.66z"
        className="Cloud-Healthcare-API_svg__cls-4"
      />
      <path d="M12.83 10.87h-1.66V9.33h1.66z" className="Cloud-Healthcare-API_svg__cls-4" />
      ...
      <path
        ...
        className="Cloud-Healthcare-API_svg__cls-6"
      />
      <path
