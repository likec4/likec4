...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <defs>
      ...
      <mask id={`mask-${suffix}`} width={14.73} height={12.76} x={4.64} y={4.19} maskUnits="userSpaceOnUse">
        <circle cx={12} cy={12.23} r={3.58} filter={`url(#luminosity-noclip-${suffix})`} />
      </mask>
    </defs>
