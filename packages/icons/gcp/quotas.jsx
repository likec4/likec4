    ...
    <g data-name="Product Icons">
      <g data-name="colored-32/quotas">
        <path
          ...
          className="cls-1"
        />
        <path id="Path-2" d="M12 22h6.73A1.29 1.29 0 0 0 20 20.58V2h-2v18h-6z" className="cls-2" data-name="Path" />
        <path id="Rectangle-328" d="M7 12h10v7H7z" className="cls-1" />
        <path id="Rectangle-328-2" d="M12 12h5v7h-5z" className="cls-2" data-name="Rectangle-328" />
      </g>
