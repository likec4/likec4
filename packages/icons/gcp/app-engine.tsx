...
const SvgAppEngine = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <defs>
      <style>
        {'.App-Engine_svg__cls-2,.App-Engine_svg__cls-3{fill-rule:evenodd}.App-Engine_svg__cls-2{fill:#aecbfa}.App-Engine_svg__cls-3{fill:#669df6}'}
      </style>
    </defs>
    <g data-name="Product Icons">
      ...
      <path
        ...
        className="App-Engine_svg__cls-2"
      />
      <path
        ...
        className="App-Engine_svg__cls-3"
      />
      <path
