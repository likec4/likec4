 ...
 */
const SvgApiMonetization = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <path
        ...
        className="cls-1"
      />
      <circle cx={9.45} cy={11.97} r={1.51} className="cls-2" />
      <circle cx={14.55} cy={11.97} r={1.51} className="cls-3" />
      <circle cx={14.55} cy={7.74} r={1.51} className="cls-2" />
      <circle cx={19.64} cy={11.97} r={1.51} className="cls-3" />
      <circle cx={19.64} cy={7.74} r={1.51} className="cls-3" />
