...
const SvgDisks = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Disks_svg__a" x1={15.35} x2={15.37} y1={13.41} y2={13.41} gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#Disks_svg__a)" d="M15.35 13.4" />
    <ellipse cx={8.96} cy={4.99} fill="url(#Disks_svg__b)" rx={7.5} ry={3.08} />
