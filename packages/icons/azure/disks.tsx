...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={15.35} x2={15.37} y1={13.41} y2={13.41} gradientUnits="userSpaceOnUse">
    ...
    <path fill={`url(#a-${suffix})`} d="M15.35 13.4" />
    <ellipse cx={8.96} cy={4.99} fill={`url(#b-${suffix})`} rx={7.5} ry={3.08} />
