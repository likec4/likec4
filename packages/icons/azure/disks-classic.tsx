...
const SvgDisksClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path fill="url(#Disks-(Classic)_svg__a)" d="M15.35 13.4" />
    <ellipse cx={8.96} cy={4.99} fill="url(#Disks-(Classic)_svg__b)" rx={7.5} ry={3.08} />
