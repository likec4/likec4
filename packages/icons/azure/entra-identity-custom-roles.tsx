...
const SvgEntraIdentityCustomRoles = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Entra-Identity-Custom-Roles_svg__a"
        x1={-609.26}
        x2={-609.26}
        y1={-224.13}
        y2={-211.218}
      ...
      <linearGradient
        id="Entra-Identity-Custom-Roles_svg__b"
        x1={-609.223}
        x2={-609.223}
        y1={-214.978}
        y2={-203.218}
    ...
    <path
      fill="url(#Entra-Identity-Custom-Roles_svg__a)"
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={7.904} cy={4.466} r={4.367} fill="url(#Entra-Identity-Custom-Roles_svg__b)" />
