...
const SvgVirtualMachinesClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Virtual-Machines-(Classic)_svg__a"
        x1={8.86}
        x2={8.86}
        y1={13.02}
        y2={1.02}
      ...
      <linearGradient
        id="Virtual-Machines-(Classic)_svg__b"
        x1={8.86}
        x2={8.86}
        y1={17.65}
        y2={13.02}
    ...
    <rect width={18} height={12} x={-0.14} y={1.02} fill="url(#Virtual-Machines-(Classic)_svg__a)" rx={0.6} />
    ...
    <path
      fill="url(#Virtual-Machines-(Classic)_svg__b)"
