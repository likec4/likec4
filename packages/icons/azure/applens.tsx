...
const SvgApplens = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Applens_svg__a" x2={18} y1={9} y2={9} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="Applens_svg__b" x1={3.092} x2={14.9} y1={8.98} y2={8.98} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id="Applens_svg__c" x1={3.154} x2={10.922} y1={6.215} y2={6.215} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
