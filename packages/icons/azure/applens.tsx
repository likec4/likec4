...
const SvgApplens = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id="b" x1={3.092} x2={14.9} y1={8.98} y2={8.98} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id="c" x1={3.154} x2={10.922} y1={6.215} y2={6.215} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
