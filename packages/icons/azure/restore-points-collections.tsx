...
const SvgRestorePointsCollections = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={8.285} x2={8.285} y1={15.127} y2={1.854} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={11.155} x2={8.63} y1={10.195} y2={8.486} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#32bedd" />
        <stop offset={1} stopColor="#9cebff" />
      </linearGradient>
      <linearGradient id="c" x1={6.837} x2={6.837} y1={11.765} y2={6.699} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#32bedd" />
        <stop offset={1} stopColor="#9cebff" />
      </linearGradient>
    </defs>
    ...
    />
    <path fill="url(#b)" d="M11.18 6.699v3.368l-2.895 1.698V8.388z" />
    <path fill="#c3f1ff" d="M11.18 6.699 8.294 8.397 5.39 6.699 8.294 5.01z" />
    <path fill="url(#c)" d="M8.285 8.397v3.368L5.39 10.067V6.699z" />
    <g fill="#fff">
