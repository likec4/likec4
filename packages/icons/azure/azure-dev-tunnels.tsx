...
const SvgAzureDevTunnels = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#Azure-Dev-Tunnels_svg__a)"
    ...
    <path fill="url(#Azure-Dev-Tunnels_svg__b)" d="M5.625 12.375 0 18h18l-5.625-5.625z" />
  </svg>
)
