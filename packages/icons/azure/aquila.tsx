...
const SvgAquila = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Aquila_svg__a" x1={10.686} x2={10.686} y1={0.143} y2={5.035} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#83b9f9" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="Aquila_svg__b" x1={14.828} x2={14.828} y1={4.906} y2={17.857} gradientUnits="userSpaceOnUse">
        <stop offset={0.154} stopColor="#83b9f9" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="Aquila_svg__c" x1={10.579} x2={10.579} y1={5.034} y2={17.815} gradientUnits="userSpaceOnUse">
        <stop offset={0.192} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="Aquila_svg__d" x1={7.95} x2={7.95} y1={0.66} y2={7.625} gradientUnits="userSpaceOnUse">
        <stop offset={0.441} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="Aquila_svg__e" x1={3.554} x2={3.554} y1={3.554} y2={12.77} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#005ba1" />
      </linearGradient>
      <linearGradient id="Aquila_svg__f" x1={6.163} x2={6.163} y1={8.759} y2={13.256} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#005ba1" />
      </linearGradient>
      <linearGradient id="Aquila_svg__g" x1={13.5} x2={13.5} y1={9.366} y2={17.428} gradientUnits="userSpaceOnUse">
        <stop offset={0.152} stopColor="#fff" />
        <stop offset={1} stopColor="#f2f2f2" />
      </linearGradient>
    </defs>
    <path
      fill="url(#Aquila_svg__a)"
      d="M14.489 5.021a8.1 8.1 0 0 0-2.832.014A12.15 12.15 0 0 0 6.883.66 5.2 5.2 0 0 1 9.24.146a5.1 5.1 0 0 1 5.249 4.875"
    />
    <path
      fill="url(#Aquila_svg__b)"
