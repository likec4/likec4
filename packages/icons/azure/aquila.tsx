...
const SvgAquila = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={10.686} x2={10.686} y1={0.143} y2={5.035} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#83b9f9" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={14.828} x2={14.828} y1={4.906} y2={17.857} gradientUnits="userSpaceOnUse">
        <stop offset={0.154} stopColor="#83b9f9" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="c" x1={10.579} x2={10.579} y1={5.034} y2={17.815} gradientUnits="userSpaceOnUse">
        <stop offset={0.192} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="d" x1={7.95} x2={7.95} y1={0.66} y2={7.625} gradientUnits="userSpaceOnUse">
        <stop offset={0.441} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="e" x1={3.554} x2={3.554} y1={3.554} y2={12.77} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#005ba1" />
      </linearGradient>
      <linearGradient id="f" x1={6.163} x2={6.163} y1={8.759} y2={13.256} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#005ba1" />
      </linearGradient>
      <linearGradient id="g" x1={13.5} x2={13.5} y1={9.366} y2={17.428} gradientUnits="userSpaceOnUse">
    ...
    />
    <ellipse cx={13.5} cy={13.373} fill="url(#g)" rx={3.917} ry={3.901} />
    <path
      fill="#83b9f9"
