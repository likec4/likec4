...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9.261} x2={6.218} y1={-0.364} y2={20.052} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#32bedd" />
        <stop offset={1} stopColor="#198ab3" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={10.798} x2={14.441} y1={7.388} y2={19.066} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={0.997} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={-0.168} x2={12.572} y1={4.114} y2={10.895} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill={`url(#c-${suffix})`} d="m7.578 2.963 1.052-.582 4.51 9.347-.366.4H2.835l.112-1.197h8.381z" />
