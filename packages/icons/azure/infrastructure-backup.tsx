...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={6.49} x2={6.49} y1={17.38} y2={0.44} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#949494" />
        <stop offset={0.53} stopColor="#a2a2a2" />
        <stop offset={1} stopColor="#b3b3b3" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={10.06} x2={16.48} y1={13.89} y2={13.89} gradientUnits="userSpaceOnUse">
...
export default SvgInfrastructureBackup
