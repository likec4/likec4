...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={2.59} x2={15.4} y1={8.18} y2={8.18} gradientUnits="userSpaceOnUse">
    ...
    <path fill="#9f9f9f" d="M13.53 5.37a.29.29 0 0 1-.28-.28V2.83a.29.29 0 0 1 .57 0v2.26a.29.29 0 0 1-.29.28" />
    <rect width={0.56} height={2.01} x={13.89} y={4.71} fill="#9f9f9f" rx={0.28} transform="rotate(135 14.169 5.717)" />
...
export default SvgElasticJobAgents
