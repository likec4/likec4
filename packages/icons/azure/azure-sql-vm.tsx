...
const SvgAzureSqlVm = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Azure-SQL-VM_svg__a" x1={9} x2={9} y1={12.46} y2={1.18} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.82} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="Azure-SQL-VM_svg__b" x1={9} x2={9} y1={16.82} y2={12.46} gradientUnits="userSpaceOnUse">
        <stop offset={0.15} stopColor="#ccc" />
        <stop offset={1} stopColor="#707070" />
      </linearGradient>
      <radialGradient id="Azure-SQL-VM_svg__c" cx={9.43} cy={7.03} r={7.27} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#f2f2f2" />
        <stop offset={0.58} stopColor="#eee" />
        <stop offset={1} stopColor="#e6e6e6" />
      </radialGradient>
    </defs>
    <rect width={16.91} height={11.27} x={0.54} y={1.18} fill="url(#Azure-SQL-VM_svg__a)" rx={0.56} />
    <path
      fill="url(#Azure-SQL-VM_svg__b)"
      d="M12.39 15.87c-1.67-.26-1.74-1.47-1.73-3.41H7.34c0 1.94-.06 3.15-1.73 3.41a1 1 0 0 0-.84 1h8.46a1 1 0 0 0-.84-1"
    />
    <path
      fill="url(#Azure-SQL-VM_svg__c)"
