...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={9} y1={12.46} y2={1.18} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.82} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={9} x2={9} y1={16.82} y2={12.46} gradientUnits="userSpaceOnUse">
        <stop offset={0.15} stopColor="#ccc" />
        <stop offset={1} stopColor="#707070" />
      </linearGradient>
      <radialGradient id={`c-${suffix}`} cx={9.43} cy={7.03} r={7.27} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#f2f2f2" />
        <stop offset={0.58} stopColor="#eee" />
        <stop offset={1} stopColor="#e6e6e6" />
      </radialGradient>
    </defs>
    <rect width={16.91} height={11.27} x={0.54} y={1.18} fill={`url(#a-${suffix})`} rx={0.56} />
    <path
      fill={`url(#b-${suffix})`}
