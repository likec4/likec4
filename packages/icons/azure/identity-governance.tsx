...
const SvgIdentityGovernance = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Identity-Governance_svg__a" x1={9} x2={9} y1={7.11} y2={14.2} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#a67af4" />
        <stop offset={1} stopColor="#552f99" />
      </linearGradient>
      <linearGradient
        id="Identity-Governance_svg__b"
        x1={8.8}
        x2={9.32}
        y1={3.31}
        y2={9.75}
    ...
    <path
      fill="url(#Identity-Governance_svg__a)"
    ...
    <circle cx={9.01} cy={5.92} r={2.39} fill="url(#Identity-Governance_svg__b)" />
  </svg>
)
