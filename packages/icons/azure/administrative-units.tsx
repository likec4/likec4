...
const SvgAdministrativeUnits = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Administrative-Units_svg__a"
        x1={9.282}
        x2={16.974}
        y1={12.079}
        y2={7.637}
      ...
      <linearGradient
        id="Administrative-Units_svg__b"
        x1={5.573}
        x2={14.846}
        y1={12.94}
        y2={7.422}
      ...
      <linearGradient
        id="Administrative-Units_svg__c"
        x1={7.118}
        x2={7.118}
        y1={784.39}
        y2={775.34}
      ...
      <linearGradient
        id="Administrative-Units_svg__d"
        x1={6.919}
        x2={7.502}
        y1={788.428}
        y2={781.18}
    ...
    <path
      fill="url(#Administrative-Units_svg__a)"
    ...
    />
    <path
      fill="url(#Administrative-Units_svg__b)"
    ...
    />
    <path
      fill="url(#Administrative-Units_svg__c)"
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={7.16} cy={6.085} r={3.058} fill="url(#Administrative-Units_svg__d)" />
    <g fill="#0078d4">
