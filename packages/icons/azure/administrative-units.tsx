...
const SvgAdministrativeUnits = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9.282} x2={16.974} y1={12.079} y2={7.637} gradientUnits="userSpaceOnUse">
        <stop offset={0.384} stopColor="#005ba1" />
        <stop offset={0.829} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="b" x1={5.573} x2={14.846} y1={12.94} y2={7.422} gradientUnits="userSpaceOnUse">
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={7.16} cy={6.085} r={3.058} fill="url(#d)" />
    <g fill="#0078d4">
