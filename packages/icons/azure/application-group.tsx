...
const SvgApplicationGroup = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Application-Group_svg__a" x1={9} x2={9} y1={17.5} y2={0.5} gradientUnits="userSpaceOnUse">
    ...
    <circle cx={9} cy={9} r={8.5} fill="url(#Application-Group_svg__a)" />
    <path
      fill="#fff"
