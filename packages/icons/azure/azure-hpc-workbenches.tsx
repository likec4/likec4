...
const SvgAzureHpcWorkbenches = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Azure-HPC-Workbenches_svg__a"
        x1={9}
        x2={9}
        y1={1.498}
        y2={17.709}
      ...
      <linearGradient
        id="Azure-HPC-Workbenches_svg__b"
        x1={9}
        x2={9}
        y1={13.77}
        y2={2.92}
      ...
      <linearGradient
        id="Azure-HPC-Workbenches_svg__c"
        x1={8.312}
        x2={8.312}
        y1={7.64}
        y2={11.257}
      ...
      <linearGradient
        id="Azure-HPC-Workbenches_svg__d"
        x1={8.22}
        x2={8.485}
        y1={5.701}
        y2={8.985}
    ...
    />
    <path
      fill="url(#Azure-HPC-Workbenches_svg__a)"
    ...
    />
    <path
      fill="url(#Azure-HPC-Workbenches_svg__b)"
    ...
    />
    <path
      fill="url(#Azure-HPC-Workbenches_svg__c)"
    ...
    <circle cx={8.327} cy={7.029} r={1.222} fill="url(#Azure-HPC-Workbenches_svg__d)" />
  </svg>
)
