...
const SvgAzureHpcWorkbenches = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={1.498} y2={17.709} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#6bb9f2" />
        <stop offset={1} stopColor="#1b93eb" />
      </linearGradient>
      <linearGradient id="b" x1={9} x2={9} y1={13.77} y2={2.92} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#e6e6e6" />
        <stop offset={1} stopColor="#fff" />
      </linearGradient>
      <linearGradient id="c" x1={8.312} x2={8.312} y1={7.64} y2={11.257} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="d" x1={8.22} x2={8.485} y1={5.701} y2={8.985} gradientUnits="userSpaceOnUse">
        <stop offset={0.225} stopColor="#32d4f5" />
        <stop offset={0.473} stopColor="#31d1f3" />
        <stop offset={0.633} stopColor="#2ec9eb" />
        <stop offset={0.999} stopColor="#198ab3" />
    ...
    <circle cx={8.327} cy={7.029} r={1.222} fill="url(#d)" />
  </svg>
)
