...
const SvgNat = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <ellipse cx={3.977} cy={9.09} fill="#fff" rx={1.577} ry={1.585} transform="rotate(-45.121 3.977 9.09)" />
    <ellipse cx={3.977} cy={9.09} fill="#86d633" rx={0.896} ry={0.905} transform="rotate(-45.061 3.976 9.09)" />
    <ellipse cx={14.014} cy={9.09} fill="#fff" rx={1.577} ry={1.585} transform="rotate(-45.121 14.015 9.09)" />
    <ellipse cx={14.014} cy={9.09} fill="#86d633" rx={0.896} ry={0.905} transform="rotate(-45.061 14.015 9.09)" />
    <path
      fill="#fff"
