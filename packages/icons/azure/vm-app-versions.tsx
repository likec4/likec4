...
const SvgVmAppVersions = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#VM-App-Versions_svg__a)"
    ...
    />
    <path
      fill="url(#VM-App-Versions_svg__b)"
    ...
    />
    <rect width={8.621} height={8.621} x={9.347} y={9.379} fill="url(#VM-App-Versions_svg__c)" rx={4.311} />
    <path
      fill="#fff"
