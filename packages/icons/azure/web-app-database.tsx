...
const SvgWebAppDatabase = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id="e" x1={8.857} x2={8.857} y1={1.834} y2={16.187} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill="url(#b)" d="M8.014 8.878a4.969 4.969 0 1 1-6.089-7.854l.052-.035a4.967 4.967 0 0 1 6.037 7.889" />
    <path
      fill="#fff"
    ...
    <path
      ...
      opacity={0.55}
    />
    <circle cx={2.269} cy={4.764} r={1.595} fill="url(#c)" />
    <path
      fill="#f2f2f2"
      ...
      opacity={0.55}
    />
    <circle cx={5.629} cy={7.68} r={1.04} fill="url(#d)" />
    <path
      fill="#f2f2f2"
