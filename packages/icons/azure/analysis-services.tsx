...
const SvgAnalysisServices = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <rect width={6.92} height={5.31} x={0.5} y={2.52} fill="url(#Analysis-Services_svg__a)" rx={0.28} />
    <rect width={6.92} height={5.31} x={10.58} y={5.58} fill="url(#Analysis-Services_svg__b)" rx={0.28} />
    <rect width={6.92} height={5.31} x={1.82} y={10.18} fill="url(#Analysis-Services_svg__c)" rx={0.42} />
    <path
      fill="#773adc"
