...
const SvgLogicAppsCustomConnector = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Logic-Apps-Custom-Connector_svg__a"
        x1={4.76}
        x2={4.76}
        y1={9.66}
        y2={17.06}
      ...
      <linearGradient
        id="Logic-Apps-Custom-Connector_svg__b"
        x1={4.83}
        x2={4.83}
        y1={1.06}
        y2={6.38}
      ...
      <linearGradient
        id="Logic-Apps-Custom-Connector_svg__c"
        x1={14.4}
        x2={14.4}
        y1={10.64}
        y2={15.95}
    ...
    <path
      fill="url(#Logic-Apps-Custom-Connector_svg__a)"
