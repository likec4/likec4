...
const SvgLogicAppsCustomConnector = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={4.76} x2={4.76} y1={9.66} y2={17.06} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#008bf1" />
        <stop offset={1} stopColor="#004dae" />
      </linearGradient>
      <linearGradient id="b" x1={4.83} x2={4.83} y1={1.06} y2={6.38} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#76bc2d" />
        <stop offset={1} stopColor="#5e9624" />
      </linearGradient>
      <linearGradient id="c" x1={14.4} x2={14.4} y1={10.64} y2={15.95} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#76bc2d" />
        <stop offset={1} stopColor="#5e9624" />
      </linearGradient>
    </defs>
