...
const SvgConfidentialLedgers = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={11.565} x2={12.577} y1={14.729} y2={14.729} gradientUnits="userSpaceOnUse">
        <stop offset={0.001} stopColor="#773adc" />
        <stop offset={1} stopColor="#552f99" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={6.415} x2={7.427} y1={5.733} y2={5.733} gradientUnits="userSpaceOnUse">
        <stop offset={0.001} stopColor="#773adc" />
        <stop offset={1} stopColor="#552f99" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={1.265} x2={2.278} y1={14.729} y2={14.729} gradientUnits="userSpaceOnUse">
        <stop offset={0.001} stopColor="#773adc" />
        <stop offset={1} stopColor="#552f99" />
      </linearGradient>
    </defs>
...
export default SvgConfidentialLedgers
