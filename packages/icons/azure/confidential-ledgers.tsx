...
const SvgConfidentialLedgers = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Confidential-Ledgers_svg__a"
        x1={11.565}
        x2={12.577}
        y1={14.729}
        y2={14.729}
      ...
      <linearGradient
        id="Confidential-Ledgers_svg__b"
        x1={6.415}
        x2={7.427}
        y1={5.733}
        y2={5.733}
      ...
      <linearGradient
        id="Confidential-Ledgers_svg__c"
        x1={1.265}
        x2={2.278}
        y1={14.729}
        y2={14.729}
    ...
    />
    <path
      fill="url(#Confidential-Ledgers_svg__a)"
    ...
    />
    <path
      fill="url(#Confidential-Ledgers_svg__b)"
    ...
    />
    <path
      fill="url(#Confidential-Ledgers_svg__c)"
