...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={8.8} x2={8.8} y1={12.87} y2={0.87} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.82} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={8.81} x2={8.81} y1={17.5} y2={12.87} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#1490df" />
        <stop offset={0.98} stopColor="#1f56a3" />
      </linearGradient>
    </defs>
    <rect width={18} height={12} x={-0.2} y={0.87} fill={`url(#a-${suffix})`} rx={0.6} />
