...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={9} y1={17.826} y2={0.826} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#198ab3" />
        <stop offset={0.442} stopColor="#28b7db" />
        <stop offset={0.775} stopColor="#32d4f5" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={5.75} x2={12.303} y1={-3114.591} y2={-3119.908} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#fff" stopOpacity={0.9} />
        <stop offset={1} stopColor="#fff" stopOpacity={0.8} />
      </linearGradient>
    </defs>
    <circle cx={9} cy={9.326} r={8.5} fill={`url(#a-${suffix})`} />
    <path
      fill={`url(#b-${suffix})`}
