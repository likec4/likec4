...
const SvgGroups = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Groups_svg__a" x1={6.7} x2={6.7} y1={7.26} y2={18.36} gradientUnits="userSpaceOnUse">
        <stop offset={0.22} stopColor="#32d4f5" />
        <stop offset={1} stopColor="#198ab3" />
      </linearGradient>
      <linearGradient id="Groups_svg__b" x1={6.42} x2={7.23} y1={1.32} y2={11.39} gradientUnits="userSpaceOnUse">
        <stop offset={0.22} stopColor="#32d4f5" />
        <stop offset={1} stopColor="#198ab3" />
      </linearGradient>
    </defs>
    ...
    <circle cx={6.74} cy={5.39} r={3.75} fill="url(#Groups_svg__b)" />
  </svg>
)
