...
const SvgApiCenter = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={9} y1={18} y2={0} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#198ab3" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={7.203} x2={7.203} y1={11.089} y2={3.888} gradientUnits="userSpaceOnUse">
