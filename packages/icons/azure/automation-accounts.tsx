...
const SvgAutomationAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Automation-Accounts_svg__a"
        x1={9}
        x2={9}
        y1={177.9}
        y2={160.1}
    ...
    <path
      fill="url(#Automation-Accounts_svg__a)"
    ...
    />
    <path
      fill="url(#Automation-Accounts_svg__b)"
...
export default SvgAutomationAccounts
