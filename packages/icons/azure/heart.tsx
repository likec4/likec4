...
const SvgHeart = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Heart_svg__a" x1={9} x2={9} y1={16.573} y2={1.427} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#b31b1b" />
        <stop offset={0.82} stopColor="#e62323" />
      </linearGradient>
      <linearGradient id="Heart_svg__b" x1={9} x2={9} y1={16.525} y2={1.427} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#b31b1b" />
        <stop offset={0.82} stopColor="#e62323" />
      </linearGradient>
    </defs>
