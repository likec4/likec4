...
const SvgToolbox = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Toolbox_svg__a" x1={9} x2={9} y1={16.431} y2={4.559} gradientUnits="userSpaceOnUse">
    ...
    />
    <rect width={17} height={11.872} x={0.5} y={4.559} fill="url(#Toolbox_svg__a)" rx={0.567} />
