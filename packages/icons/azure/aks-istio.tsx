...
const SvgAksIstio = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="b" x1={-1.024} x2={15.931} y1={19.038} y2={2.083} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="c" x1={2.077} x2={19.04} y1={2.063} y2={19.026} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
        <stop offset={1} stopColor="#003067" />
      </linearGradient>
      <linearGradient id="d" x1={2.069} x2={19.024} y1={15.917} y2={-1.038} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="e" x1={-1.04} x2={15.923} y1={-1.026} y2={15.937} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#83b9f9" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <radialGradient id="a" cx={7.495} cy={7.696} r={5.405} gradientUnits="userSpaceOnUse">
    ...
    <circle cx={9.056} cy={9} r={3.49} fill="url(#a)" />
    <path
      fill="url(#b)"
