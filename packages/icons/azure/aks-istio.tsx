...
const SvgAksIstio = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id="AKS-Istio_svg__c" x1={2.077} x2={19.04} y1={2.063} y2={19.026} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
      ...
      <radialGradient id="AKS-Istio_svg__a" cx={7.495} cy={7.696} r={5.405} gradientUnits="userSpaceOnUse">
