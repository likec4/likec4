...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <path fill="#59285f" d="M15.434 9.798v1.72l-6.44 3.78-6.43-3.78v-1.72l1.72 1.01 1.71 1 3 1.77 3.01-1.77 1.72-1z" />
    <path fill="#a33a85" d="m15.434 6.488-1.71 1-1.11.65-.61.36-3.01 1.76-3-1.76-.61-.36-1.1-.65-1.72-1 6.43-3.79z" />
    <path
      fill="#59285f"
