...
const SvgUserSettings = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={6.85} x2={6.85} y1={7.226} y2={18.562} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={6.563} x2={7.391} y1={1.149} y2={11.442} gradientUnits="userSpaceOnUse">
        <stop offset={0.225} stopColor="#32d4f5" />
        <stop offset={0.473} stopColor="#31d1f3" />
        <stop offset={0.888} stopColor="#22a5cb" />
        <stop offset={0.999} stopColor="#198ab3" />
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={6.898} cy={5.313} r={3.829} fill="url(#b)" />
  </svg>
)
