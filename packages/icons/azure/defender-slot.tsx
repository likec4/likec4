...
const SvgDefenderSlot = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" {...props}>
    <rect width={4.286} height={18} fill="url(#Defender-Slot_svg__a)" rx={1} />
    <path
      fill="#fff"
    ...
    />
    <defs>
      <linearGradient id="Defender-Slot_svg__a" x1={2.143} x2={2.143} y1={18} y2={0} gradientUnits="userSpaceOnUse">
