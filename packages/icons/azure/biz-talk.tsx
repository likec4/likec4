...
const SvgBizTalk = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={13.343} y2={0.586} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={9.104} x2={9.104} y1={10.28} y2={7.603} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#76bc2d" />
        <stop offset={0.412} stopColor="#7ac32f" />
        <stop offset={1} stopColor="#86d633" />
      </linearGradient>
      <linearGradient id="c" x1={9.119} x2={9.119} y1={17.414} y2={13.924} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
    </defs>
