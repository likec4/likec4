...
const SvgLabAccounts = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={6.136} x2={6.274} y1={0.665} y2={13.402} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={13.259} x2={13.259} y1={5.363} y2={17.405} gradientUnits="userSpaceOnUse">
    ...
    />
    <rect width={3.911} height={0.461} x={11.337} y={8.957} fill="#faa21d" rx={0.21} />
    <rect width={3.911} height={0.461} x={11.337} y={9.709} fill="#faa21d" rx={0.21} />
    <path
      fill="#fff"
