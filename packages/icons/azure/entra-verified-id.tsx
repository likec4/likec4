...
const SvgEntraVerifiedId = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={8.985} x2={8.985} y1={13.416} y2={0.837} gradientUnits="userSpaceOnUse">
        <stop offset={0.089} stopColor="#225086" />
        <stop offset={0.458} stopColor="#0055c5" />
      </linearGradient>
      <linearGradient id="b" x1={15.2} x2={15.2} y1={17.152} y2={8.114} gradientUnits="userSpaceOnUse">
