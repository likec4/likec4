...
const SvgContentSafety = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={7.997} x2={7.997} y1={14.863} y2={2.057} gradientUnits="userSpaceOnUse">
    ...
    <rect width={3.721} height={0.691} x={8.155} y={5.742} fill="#fff" opacity={0.6} rx={0.141} ry={0.141} />
    <rect width={4.472} height={0.691} x={4.117} y={9.983} fill="#fff" opacity={0.3} rx={0.141} ry={0.141} />
