...
const SvgAzureSupportCenterBlue = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={3.474} y2={18.601} gradientUnits="userSpaceOnUse">
        <stop offset={0.215} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="b" x1={8.974} x2={8.974} y1={-0.698} y2={9.083} gradientUnits="userSpaceOnUse">
