...
const SvgAzureSupportCenterBlue = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Azure-Support-Center-Blue_svg__a"
        x1={9}
        x2={9}
        y1={3.474}
        y2={18.601}
      ...
      <linearGradient
        id="Azure-Support-Center-Blue_svg__b"
        x1={8.974}
        x2={8.974}
        y1={-0.698}
        y2={9.083}
    ...
    <path
      fill="url(#Azure-Support-Center-Blue_svg__a)"
    ...
    />
    <path
      fill="url(#Azure-Support-Center-Blue_svg__b)"
