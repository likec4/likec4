...
const SvgIpGroups = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path fill="#83b9f9" d="M.5 4.429h9.548v5.327a.32.32 0 0 1-.321.321H.821A.32.32 0 0 1 .5 9.756Z" />
    <path fill="#1f56a3" d="M.821 2.389h8.906a.32.32 0 0 1 .321.321v1.719H.5V2.71a.32.32 0 0 1 .321-.321" />
    <rect width={6.979} height={0.822} x={1.784} y={3.003} fill="#f2f2f2" rx={0.161} />
    ...
    <path fill="url(#a)" d="M7.952 9.963H17.5v5.327a.32.32 0 0 1-.321.321H8.273a.32.32 0 0 1-.321-.321Z" />
