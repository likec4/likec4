...
const SvgAzureSustainability = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={12.603} y2={0.003} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={7.271} x2={16.7} y1={13.496} y2={13.496} gradientUnits="userSpaceOnUse">
        <stop offset={0.496} stopColor="#5e9624" />
        <stop offset={0.999} stopColor="#365615" />
      </linearGradient>
      <linearGradient id="c" x1={8.571} x2={18} y1={13.544} y2={13.544} gradientUnits="userSpaceOnUse">
