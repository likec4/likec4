...
const SvgAzureSustainability = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Azure-Sustainability_svg__a"
        x1={9}
        x2={9}
        y1={12.603}
        y2={0.003}
      ...
      <linearGradient
        id="Azure-Sustainability_svg__b"
        x1={7.271}
        x2={16.7}
        y1={13.496}
        y2={13.496}
      ...
      <linearGradient
        id="Azure-Sustainability_svg__c"
        x1={8.571}
        x2={18}
        y1={13.544}
        y2={13.544}
    ...
    <path
      fill="url(#Azure-Sustainability_svg__a)"
    ...
    />
    <path
      fill="url(#Azure-Sustainability_svg__b)"
    ...
    />
    <path
      fill="url(#Azure-Sustainability_svg__c)"
