...
const SvgBackupVault = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={11.462} x2={11.462} y1={10.536} y2={1.423} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`b-${suffix}`} x1={6.484} x2={6.484} y1={16.577} y2={7.461} gradientUnits="userSpaceOnUse">
