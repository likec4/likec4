...
const SvgCollaborativeService = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={13.398} x2={13.398} y1={1.747} y2={7.447} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="b" x1={2.85} x2={2.85} y1={5.341} y2={11.041} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#a67af4" />
        <stop offset={1} stopColor="#773adc" />
      </linearGradient>
      <linearGradient id="c" x1={11.829} x2={11.829} y1={12.149} y2={20.004} gradientUnits="userSpaceOnUse">
    ...
    />
    <circle cx={13.398} cy={4.597} r={2.85} fill="url(#a)" />
    <path fill="url(#b)" d="M2.849 5.382A2.85 2.85 0 1 0 5.7 8.231a2.85 2.85 0 0 0-2.851-2.849" />
    <path fill="url(#c)" d="M11.828 12.149A2.85 2.85 0 1 0 14.679 15a2.85 2.85 0 0 0-2.851-2.851" />
    {'\u200B'}
  </svg>
)
