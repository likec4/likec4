...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={7.849} x2={7.849} y1={12.323} y2={4.229} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.502} stopColor="#4093e6" />
        <stop offset={0.775} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={10.151} x2={10.151} y1={16.69} y2={8.595} gradientUnits="userSpaceOnUse">
    ...
    <path fill={`url(#a-${suffix})`} d="M1 4.229h13.7v7.637a.46.46 0 0 1-.458.458H1.458A.46.46 0 0 1 1 11.866z" />
    <path fill="#0078d4" d="M1.46 1.31h12.777a.46.46 0 0 1 .458.458v2.461H1V1.768a.46.46 0 0 1 .46-.458" />
    <path fill={`url(#b-${suffix})`} d="M3.3 8.6H17v7.637a.46.46 0 0 1-.458.458H3.76a.46.46 0 0 1-.458-.458V8.6z" />
