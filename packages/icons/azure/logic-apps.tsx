...
const SvgLogicApps = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Logic-Apps_svg__a" x1={9} x2={9} y1={1.796} y2={6.371} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#9cebff" />
        <stop offset={1} stopColor="#50e6ff" />
      </linearGradient>
      <linearGradient
        id="Logic-Apps_svg__b"
        x1={3.374}
        x2={3.374}
        y1={12.14}
        y2={18.457}
    ...
    />
    <rect width={6.747} height={6.747} x={5.626} y={-0.02} fill="url(#Logic-Apps_svg__a)" rx={0.604} />
    <rect width={6.747} height={6.747} y={11.273} fill="url(#Logic-Apps_svg__b)" rx={0.604} />
    <rect
      width={6.747}
      height={6.747}
      x={11.253}
      y={11.273}
      fill="url(#Logic-Apps_svg__c)"
      rx={0.604}
