...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={9} y1={16.236} y2={5.599} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
        <stop offset={0.775} stopColor="#0078d4" />
      </linearGradient>
    </defs>
    <path fill={`url(#a-${suffix})`} d="M0 5.6h18v10.035a.6.6 0 0 1-.6.6H.6a.6.6 0 0 1-.6-.6z" />
