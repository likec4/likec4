...
const SvgVmScaleSets = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={12.74} x2={12.74} y1={15.28} y2={8.52} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.82} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={12.74} x2={12.74} y1={17.89} y2={15.28} gradientUnits="userSpaceOnUse">
    ...
    <rect width={10.11} height={6.75} x={7.68} y={8.52} fill="url(#a)" rx={0.34} />
