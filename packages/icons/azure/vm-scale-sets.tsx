...
const SvgVmScaleSets = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={12.74} x2={12.74} y1={15.28} y2={8.52} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={0.82} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={12.74} x2={12.74} y1={17.89} y2={15.28} gradientUnits="userSpaceOnUse">
        <stop offset={0.15} stopColor="#ccc" />
        <stop offset={1} stopColor="#707070" />
      </linearGradient>
    </defs>
    <rect width={10.11} height={6.75} x={0.79} y={0.89} fill="#005ba1" rx={0.34} />
    ...
    <rect width={10.11} height={6.75} x={4.76} y={4.76} fill="#0078d4" rx={0.34} />
    ...
    <rect width={10.11} height={6.75} x={7.68} y={8.52} fill={`url(#a-${suffix})`} rx={0.34} />
