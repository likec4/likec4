...
const SvgServiceProviders = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#Service-Providers_svg__a)"
    ...
    <circle cx={7.48} cy={4.25} r={4.08} fill="url(#Service-Providers_svg__b)" />
    <path
      fill="url(#Service-Providers_svg__c)"
