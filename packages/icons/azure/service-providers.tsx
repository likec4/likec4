...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={6.49} x2={6.49} y1={6.29} y2={18.38} gradientUnits="userSpaceOnUse">
        <stop offset={0.1} stopColor="#54aef0" />
        <stop offset={1} stopColor="#1988d9" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={7.13} x2={8.01} y1={-0.19} y2={10.79} gradientUnits="userSpaceOnUse">
        <stop offset={0.1} stopColor="#54aef0" />
        <stop offset={1} stopColor="#1988d9" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={13.76} x2={13.76} y1={18.05} y2={10.25} gradientUnits="userSpaceOnUse">
    ...
    <circle cx={7.48} cy={4.25} r={4.08} fill={`url(#b-${suffix})`} />
    <path
      fill={`url(#c-${suffix})`}
