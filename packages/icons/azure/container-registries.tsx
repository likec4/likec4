...
const SvgContainerRegistries = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Container-Registries_svg__a"
        x1={8.637}
        x2={8.637}
        y1={-1.991}
        y2={16.739}
      ...
      <linearGradient
        id="Container-Registries_svg__b"
        x1={12.96}
        x2={12.96}
        y1={8.561}
        y2={6.141}
    ...
    <path
      fill="url(#Container-Registries_svg__a)"
    ...
    <path fill="url(#Container-Registries_svg__b)" d="m17.99 13.119-2.16.74-7.9-1.42 2.15-1z" />
