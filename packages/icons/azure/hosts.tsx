...
const SvgHosts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9.02} x2={9.02} y1={5.46} y2={0.65} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#198ab3" />
        <stop offset={1} stopColor="#32d4f5" />
      </linearGradient>
      <linearGradient id="b" x1={8.98} x2={8.98} y1={11.97} y2={7.17} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#198ab3" />
        <stop offset={1} stopColor="#32d4f5" />
      </linearGradient>
      <linearGradient id="c" x1={9.02} x2={9.02} y1={17.34} y2={14.32} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#198ab3" />
        <stop offset={1} stopColor="#32d4f5" />
      </linearGradient>
    </defs>
    ...
    <circle cx={9.02} cy={15.83} r={1.51} fill="url(#c)" />
    <g fill="#b4ec36">
