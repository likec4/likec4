...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <radialGradient id={`a-${suffix}`} cx={8.81} cy={9} r={8.41} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#7956ba" />
        <stop offset={0.69} stopColor="#724eb4" />
        <stop offset={0.87} stopColor="#6f4bb2" />
      </radialGradient>
      <radialGradient id={`b-${suffix}`} cx={8.8} cy={9.11} r={1.19} gradientUnits="userSpaceOnUse">
    ...
    <circle cx={8.81} cy={9.08} r={1.2} fill={`url(#b-${suffix})`} />
  </svg>
)}
