...
const SvgMedTechService = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={13.092} x2={13.092} y1={15.355} y2={6.643} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`c-${suffix}`} x1={6.989} x2={6.989} y1={1.319} y2={12.992} gradientUnits="userSpaceOnUse">
        <stop offset={0.225} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </linearGradient>
    </defs>
    <rect width={0.667} height={3.487} x={16.935} y={8.059} fill="#0078d4" rx={0.229} />
    <rect width={0.667} height={1.254} x={16.935} y={12.204} fill="#0078d4" rx={0.229} />
    <path
      fill="#005ba1"
    ...
    />
    <rect width={8.151} height={8.712} x={9.016} y={6.643} fill={`url(#a-${suffix})`} rx={0.371} />
    <rect width={6.797} height={7.271} x={9.732} y={7.363} fill="#005ba1" rx={0.31} />
    <path
      fill={`url(#b-${suffix})`}
...
export default SvgMedTechService
