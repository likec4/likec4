...
const SvgMedTechService = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <rect width={8.151} height={8.712} x={9.016} y={6.643} fill="url(#MedTech-Service_svg__a)" rx={0.371} />
    <rect width={6.797} height={7.271} x={9.732} y={7.363} fill="#005ba1" rx={0.31} />
    <path
      fill="url(#MedTech-Service_svg__b)"
    ...
    />
    <path
      fill="url(#MedTech-Service_svg__c)"
