...
const SvgMedTechService = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={13.092} x2={13.092} y1={15.355} y2={6.643} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="c" x1={6.989} x2={6.989} y1={1.319} y2={12.992} gradientUnits="userSpaceOnUse">
    ...
    />
    <rect width={8.151} height={8.712} x={9.016} y={6.643} fill="url(#a)" rx={0.371} />
