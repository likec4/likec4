...
const SvgSqlDatabase = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <radialGradient id="SQL-Database_svg__b" cx={9.36} cy={10.57} r={7.07} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#f2f2f2" />
        <stop offset={0.58} stopColor="#eee" />
        <stop offset={1} stopColor="#e6e6e6" />
      </radialGradient>
      <linearGradient
        id="SQL-Database_svg__a"
        x1={2.59}
        x2={15.41}
        y1={10.16}
        y2={10.16}
