...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id={`b-${suffix}`} x1={6.16} x2={5.73} y1={14.55} y2={12.09} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#ccc" />
        <stop offset={1} stopColor="#fcfcfc" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={11.73} x2={11.3} y1={11.87} y2={9.41} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#ccc" />
        <stop offset={1} stopColor="#fcfcfc" />
      </linearGradient>
      <linearGradient id={`d-${suffix}`} x1={11.73} x2={11.3} y1={17.34} y2={14.88} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#ccc" />
        <stop offset={1} stopColor="#fcfcfc" />
      </linearGradient>
    </defs>
    ...
    <circle cx={5.94} cy={13.32} r={1.25} fill={`url(#b-${suffix})`} />
    <circle cx={11.51} cy={10.64} r={1.25} fill={`url(#c-${suffix})`} />
    <circle cx={11.51} cy={16.11} r={1.25} fill={`url(#d-${suffix})`} />
  </svg>
)}
