...
const SvgError = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={13.145} y2={0.387} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={13.102} x2={13.102} y1={17.613} y2={9.07} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill="url(#b)" d="M10.588 14.3a2.53 2.53 0 0 0 .027 1.49 2.609 2.609 0 0 0 5-1.49l-2.5-5.225Z" />
  </svg>
)
