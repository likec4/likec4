...
const SvgCodeOptimization = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#Code-Optimization_svg__a)"
    ...
    />
    <path
      fill="url(#Code-Optimization_svg__b)"
    ...
    />
    <path
      fill="url(#Code-Optimization_svg__c)"
    ...
    />
    <path
      fill="url(#Code-Optimization_svg__d)"
    ...
    />
    <path
      fill="url(#Code-Optimization_svg__e)"
