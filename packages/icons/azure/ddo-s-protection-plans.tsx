...
const SvgDDoSProtectionPlans = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={1.36} y2={17.87} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill="#003067" d="M7 5a.6.6 0 0 1 .6-.6h2.8a.6.6 0 0 1 .6.6.6.6 0 0 1-.6.61H7.6A.6.6 0 0 1 7 5" />
