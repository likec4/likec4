...
const SvgSpatialAnchorAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={8.22} x2={8.22} y1={8.09} y2={4.71} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={1} stopColor="#b77af4" />
      </linearGradient>
      <linearGradient id="b" x1={2.36} x2={2.36} y1={12.63} y2={9.25} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={1} stopColor="#b77af4" />
      </linearGradient>
      <linearGradient id="c" x1={8.22} x2={8.22} y1={17.5} y2={14.12} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={1} stopColor="#b77af4" />
      </linearGradient>
      <linearGradient id="d" x1={14.08} x2={14.08} y1={0.5} y2={11.54} gradientUnits="userSpaceOnUse">
