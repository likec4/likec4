...
const SvgSpatialAnchorAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Spatial-Anchor-Accounts_svg__a"
        x1={8.22}
        x2={8.22}
        y1={8.09}
        y2={4.71}
      ...
      <linearGradient
        id="Spatial-Anchor-Accounts_svg__b"
        x1={2.36}
        x2={2.36}
        y1={12.63}
        y2={9.25}
      ...
      <linearGradient
        id="Spatial-Anchor-Accounts_svg__c"
        x1={8.22}
        x2={8.22}
        y1={17.5}
        y2={14.12}
      ...
      <linearGradient
        id="Spatial-Anchor-Accounts_svg__d"
        x1={14.08}
        x2={14.08}
        y1={0.5}
        y2={11.54}
    ...
    />
    <circle cx={8.22} cy={6.4} r={1.69} fill="url(#Spatial-Anchor-Accounts_svg__a)" />
    <circle cx={2.36} cy={10.94} r={1.69} fill="url(#Spatial-Anchor-Accounts_svg__b)" />
    <circle cx={8.22} cy={15.81} r={1.69} fill="url(#Spatial-Anchor-Accounts_svg__c)" />
    <path
      fill="url(#Spatial-Anchor-Accounts_svg__d)"
