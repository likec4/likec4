...
const SvgEntraPrivlegedIdentityManagement = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Entra-Privleged-Identity-Management_svg__a"
        x1={-85}
        x2={-85}
        y1={777.516}
        y2={795.516}
      ...
      <linearGradient
        id="Entra-Privleged-Identity-Management_svg__b"
        x1={7.996}
        x2={12.911}
        y1={779.969}
        y2={785.714}
      ...
      <linearGradient
        id="Entra-Privleged-Identity-Management_svg__c"
        x1={9}
        x2={9}
        y1={777.497}
        y2={792.036}
      ...
      <linearGradient
        id="Entra-Privleged-Identity-Management_svg__d"
        x1={6.97}
        x2={6.97}
        y1={779.196}
        y2={791.703}
      ...
      <linearGradient
        id="Entra-Privleged-Identity-Management_svg__e"
        x1={12.463}
        x2={12.463}
        y1={776.546}
        y2={788.909}
    ...
    <circle cx={9} cy={9} r={9} fill="url(#Entra-Privleged-Identity-Management_svg__a)" />
    <path
      fill="url(#Entra-Privleged-Identity-Management_svg__b)"
    ...
    />
    <path
      fill="url(#Entra-Privleged-Identity-Management_svg__c)"
      d="m5.64 9.845.04.025L9 11.945l3.359-2.1h.001-.001L9 6.055z"
    />
    <path
      fill="url(#Entra-Privleged-Identity-Management_svg__d)"
    ...
    />
    <path
      fill="url(#Entra-Privleged-Identity-Management_svg__e)"
      fillOpacity={0.5}
