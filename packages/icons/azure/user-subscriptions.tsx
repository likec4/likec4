...
const SvgUserSubscriptions = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#User-Subscriptions_svg__a)"
    ...
    <circle cx={7.9} cy={4.8} r={4.21} fill="url(#User-Subscriptions_svg__b)" />
    <path
      fill="url(#User-Subscriptions_svg__c)"
