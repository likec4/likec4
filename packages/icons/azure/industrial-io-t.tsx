...
const SvgIndustrialIoT = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={2.053} x2={2.053} y1={3.258} y2={5.918} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id="b" x1={9.034} x2={9.034} y1={15.265} y2={17.924} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id="c" x1={15.947} x2={15.947} y1={3.34} y2={5.999} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id="d" x1={9.001} x2={9.001} y1={7.048} y2={13.068} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#50e6ff" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
    </defs>
    ...
    />
    <circle cx={2.053} cy={4.664} r={1.33} fill="url(#a)" />
    <circle cx={9.034} cy={16.67} r={1.33} fill="url(#b)" />
    <circle cx={15.947} cy={4.745} r={1.33} fill="url(#c)" />
    <path
      fill="#32bedd"
