...
const SvgIndustrialIoT = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <circle cx={2.053} cy={4.664} r={1.33} fill="url(#Industrial-IoT_svg__a)" />
    <circle cx={9.034} cy={16.67} r={1.33} fill="url(#Industrial-IoT_svg__b)" />
    <circle cx={15.947} cy={4.745} r={1.33} fill="url(#Industrial-IoT_svg__c)" />
    <path
      fill="#32bedd"
    ...
    />
    <path
      fill="url(#Industrial-IoT_svg__d)"
