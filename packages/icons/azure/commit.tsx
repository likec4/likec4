...
const SvgCommit = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Commit_svg__a" x1={9} x2={9} y1={9.387} y2={0.486} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="Commit_svg__b" x1={9} x2={9} y1={17.514} y2={11.713} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={0.735} stopColor="#a67af4" />
      </linearGradient>
    </defs>
    <path
      fill="url(#Commit_svg__a)"
    ...
    />
    <rect width={18} height={5.801} y={11.713} fill="url(#Commit_svg__b)" rx={0.581} />
