...
const SvgDataFactories = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={0.5} x2={9} y1={9.77} y2={9.77} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill="url(#a)" d="M4.75 3.58C2.4 3.58.5 2.89.5 2v14.93a.56.56 0 0 0 .57.57H9V2c0 .89-1.9 1.58-4.25 1.58" />
