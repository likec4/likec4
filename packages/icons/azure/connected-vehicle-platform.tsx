...
const SvgConnectedVehiclePlatform = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={7.028} x2={7.028} y1={1.179} y2={14.227} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5ea0ef" />
        <stop offset={0.373} stopColor="#378fe4" />
        <stop offset={0.844} stopColor="#0078d4" />
      </linearGradient>
      <linearGradient id="b" x1={10.348} x2={10.348} y1={14.579} y2={9.835} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="d" x1={53.843} x2={53.843} y1={91.717} y2={89.319} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#ccc" />
        <stop offset={0.221} stopColor="#d8d8d8" />
        <stop offset={1} stopColor="#fff" />
      </linearGradient>
    ...
    <path fill="url(#c)" d="M8.91 12.186a1.177 1.177 0 1 1 1.31 1.039 1.156 1.156 0 0 1-1.31-1.039" />
    <path fill="url(#d)" d="M5.585 7.152a1.177 1.177 0 1 1 1.309 1.039 1.154 1.154 0 0 1-1.309-1.039" />
  </svg>
)
