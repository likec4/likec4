...
const SvgConnectedVehiclePlatform = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Connected-Vehicle-Platform_svg__a"
        x1={7.028}
        x2={7.028}
        y1={1.179}
        y2={14.227}
      ...
      <linearGradient
        id="Connected-Vehicle-Platform_svg__b"
        x1={10.348}
        x2={10.348}
        y1={14.579}
        y2={9.835}
      ...
      <linearGradient
        id="Connected-Vehicle-Platform_svg__c"
        x1={56.505}
        x2={56.505}
        y1={97.131}
        y2={94.734}
      ...
      <linearGradient
        id="Connected-Vehicle-Platform_svg__d"
        x1={53.843}
        x2={53.843}
        y1={91.717}
        y2={89.319}
    ...
    <path
      fill="url(#Connected-Vehicle-Platform_svg__a)"
    ...
    />
    <path
      fill="url(#Connected-Vehicle-Platform_svg__b)"
    ...
    <path
      fill="url(#Connected-Vehicle-Platform_svg__c)"
      d="M8.91 12.186a1.177 1.177 0 1 1 1.31 1.039 1.156 1.156 0 0 1-1.31-1.039"
    />
    <path
      fill="url(#Connected-Vehicle-Platform_svg__d)"
