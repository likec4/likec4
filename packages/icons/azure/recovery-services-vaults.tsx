...
const SvgRecoveryServicesVaults = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={11.13} x2={11.13} y1={10.95} y2={1.21} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={7.06} x2={7.06} y1={16.79} y2={6.78} gradientUnits="userSpaceOnUse">
