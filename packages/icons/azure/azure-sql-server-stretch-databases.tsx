...
const SvgAzureSqlServerStretchDatabases = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Azure-SQL-Server-Stretch-Databases_svg__a"
        x1={7.37}
        x2={7.37}
        y1={0.5}
        y2={13.23}
      ...
      <linearGradient
        id="Azure-SQL-Server-Stretch-Databases_svg__b"
        x1={8.96}
        x2={17.32}
        y1={13.29}
        y2={13.29}
    ...
    <path
      fill="url(#Azure-SQL-Server-Stretch-Databases_svg__a)"
    ...
    />
    <path
      fill="url(#Azure-SQL-Server-Stretch-Databases_svg__b)"
