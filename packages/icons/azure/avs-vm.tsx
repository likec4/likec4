...
const SvgAvsVm = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={12.798} y2={0.798} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#76bc2d" />
        <stop offset={0.817} stopColor="#86d633" />
      </linearGradient>
      <linearGradient id="b" x1={9} x2={9} y1={17.434} y2={12.798} gradientUnits="userSpaceOnUse">
        <stop offset={0.149} stopColor="#ccc" />
        <stop offset={1} stopColor="#707070" />
      </linearGradient>
    </defs>
    <rect width={18} height={12} y={0.798} fill="url(#a)" rx={0.601} />
    <g fill="#fff">
