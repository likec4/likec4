...
const SvgAppComplianceAutomation = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="App-Compliance-Automation_svg__a"
        x1={-235}
        x2={-235}
        y1={996.992}
        y2={979.11}
      ...
      <linearGradient
        id="App-Compliance-Automation_svg__b"
        x1={-234.949}
        x2={-234.949}
        y1={812.064}
        y2={803.315}
      ...
      <linearGradient
        id="App-Compliance-Automation_svg__c"
        x1={9.051}
        x2={9.051}
        y1={11.847}
        y2={7.673}
    ...
    <path
      fill="url(#App-Compliance-Automation_svg__a)"
    ...
    />
    <path
      fill="url(#App-Compliance-Automation_svg__b)"
    ...
    />
    <ellipse cx={9.051} cy={9.76} fill="url(#App-Compliance-Automation_svg__c)" rx={2.078} ry={2.087} />
    <path
      fill="#fff"
