...
const SvgDefenderDistributerControlSystem = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" {...props}>
    <g clipPath="url(#Defender-Distributer-Control-System_svg__a)">
      <path
        fill="url(#Defender-Distributer-Control-System_svg__b)"
      ...
      />
      <path
        fill="url(#Defender-Distributer-Control-System_svg__c)"
    ...
    <defs>
      <linearGradient
        id="Defender-Distributer-Control-System_svg__b"
        x1={9}
        x2={9}
        y1={18}
        y2={0}
      ...
      <linearGradient
        id="Defender-Distributer-Control-System_svg__c"
        x1={9.17}
        x2={9.17}
        y1={3.575}
        y2={10.887}
      ...
      <clipPath id="Defender-Distributer-Control-System_svg__a">
