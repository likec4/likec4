...
const SvgUniversalPrint = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#Universal-Print_svg__a)"
    ...
    <rect width={7.367} height={5.55} x={8.57} y={4.246} fill="url(#Universal-Print_svg__b)" rx={0.3} />
    ...
    <path
      fill="url(#Universal-Print_svg__c)"
