...
const SvgUniversalPrint = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={8.991} x2={8.991} y1={14.11} y2={1.365} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={0.817} stopColor="#a67af4" />
      </linearGradient>
      <linearGradient id="b" x1={12.253} x2={12.253} y1={4.246} y2={9.797} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#c3f1ff" />
        <stop offset={0.999} stopColor="#9cebff" />
      </linearGradient>
      <linearGradient id="c" x1={12.253} x2={12.253} y1={16.635} y2={12.512} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#c3f1ff" />
        <stop offset={0.999} stopColor="#9cebff" />
      </linearGradient>
    </defs>
    ...
    <rect width={7.367} height={5.55} x={8.57} y={4.246} fill="url(#b)" rx={0.3} />
    ...
    <path fill="url(#c)" d="M8.57 12.512h7.367v3.823a.3.3 0 0 1-.3.3H8.869a.3.3 0 0 1-.3-.3v-3.823z" />
  </svg>
)
