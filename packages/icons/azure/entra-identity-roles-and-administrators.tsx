...
const SvgEntraIdentityRolesAndAdministrators = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={7.93} x2={7.93} y1={17.95} y2={5.62} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={1} stopColor="#b4ec36" />
      </linearGradient>
      <linearGradient id="b" x1={7.95} x2={7.95} y1={9.21} y2={-2.02} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={1} stopColor="#b4ec36" />
      </linearGradient>
    </defs>
