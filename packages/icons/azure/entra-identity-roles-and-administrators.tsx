...
const SvgEntraIdentityRolesAndAdministrators = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Entra-Identity-Roles-and-Administrators_svg__a"
        x1={7.93}
        x2={7.93}
        y1={17.95}
        y2={5.62}
      ...
      <linearGradient
        id="Entra-Identity-Roles-and-Administrators_svg__b"
        x1={7.95}
        x2={7.95}
        y1={9.21}
        y2={-2.02}
    ...
    <path
      fill="url(#Entra-Identity-Roles-and-Administrators_svg__a)"
    ...
    <circle cx={7.95} cy={4.67} r={4.17} fill="url(#Entra-Identity-Roles-and-Administrators_svg__b)" />
