...
const SvgEventGridTopics = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={7.94} x2={7.94} y1={7.7} y2={3.75} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={1} stopColor="#76bc2d" />
      </linearGradient>
      <linearGradient id="b" x1={7.94} x2={7.94} y1={14.26} y2={10.31} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={1} stopColor="#76bc2d" />
      </linearGradient>
    </defs>
    <g fill="#a3a3a3">
      ...
      <path d="M1.06 1.42h1.29V5a.29.29 0 0 1-.29.29H.77A.29.29 0 0 1 .48 5V2a.57.57 0 0 1 .58-.58" opacity={0.5} />
    </g>
    <g fill="#a3a3a3">
      <path d="M15.65 1.42h1.29a.57.57 0 0 1 .57.57V5a.29.29 0 0 1-.29.29h-1.28a.29.29 0 0 1-.29-.29z" />
      <path d="M15.65 1.42h1.29a.57.57 0 0 1 .57.57V5a.29.29 0 0 1-.29.29h-1.28a.29.29 0 0 1-.29-.29z" opacity={0.5} />
    </g>
    <path fill="#949494" d="M17.51 1.98v1.25h-17V1.98a.57.57 0 0 1 .57-.57h15.86a.57.57 0 0 1 .57.57" />
    <g fill="#a3a3a3">
    ...
    <path fill="#949494" d="M.48 16.02v-1.25h17v1.25a.57.57 0 0 1-.57.57H1.05a.57.57 0 0 1-.57-.57" />
    <path
      fill="#5ea0ef"
