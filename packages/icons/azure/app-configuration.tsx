...
const SvgAppConfiguration = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={15.63} y2={-2.51} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={12.26} x2={12.26} y1={7.17} y2={17.21} gradientUnits="userSpaceOnUse">
