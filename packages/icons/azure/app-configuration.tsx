...
const SvgAppConfiguration = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="App-Configuration_svg__a" x1={9} x2={9} y1={15.63} y2={-2.51} gradientUnits="userSpaceOnUse">
    ...
    <path
      fill="url(#App-Configuration_svg__a)"
    ...
    />
    <path
      fill="url(#App-Configuration_svg__b)"
    ...
    />
    <path fill="#fff" d="M12.37 13.72A1.64 1.64 0 1 1 14 12.07a1.65 1.65 0 0 1-1.63 1.65" />
  </svg>
)
export default SvgAppConfiguration
