...
const SvgSignalR = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <radialGradient id="SignalR_svg__a" cx={9} cy={9} r={8.5} gradientUnits="userSpaceOnUse">
        <stop offset={0.18} stopColor="#5ea0ef" />
        <stop offset={1} stopColor="#0078d4" />
      </radialGradient>
      <clipPath id="SignalR_svg__b">
        <path fill="none" d="M14.21 15.72A8.5 8.5 0 0 1 3.79 2.28l.09-.06a8.5 8.5 0 0 1 10.33 13.5" />
      </clipPath>
    </defs>
    <path fill="url(#SignalR_svg__a)" d="M14.21 15.72A8.5 8.5 0 0 1 3.79 2.28l.09-.06a8.5 8.5 0 0 1 10.33 13.5" />
    <g clipPath="url(#SignalR_svg__b)">
      <path
        fill="#f2f2f2"
