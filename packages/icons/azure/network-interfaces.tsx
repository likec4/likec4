...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9.01} x2={9.01} y1={16.5} y2={1.5} gradientUnits="userSpaceOnUse">
    ...
    />
    <rect width={13.76} height={15} x={2.13} y={1.5} fill={`url(#a-${suffix})`} rx={0.69} />
    <path
      fill="#b4ec36"
    ...
    />
    <rect width={6.14} height={3.11} x={7.07} y={2.29} fill="#365615" rx={0.26} />
    <rect width={4.9} height={1.09} x={5.86} y={12.69} fill="#365615" rx={0.26} transform="rotate(90 8.305 13.235)" />
    <rect width={4.9} height={1.09} x={3.99} y={12.71} fill="#365615" rx={0.26} transform="rotate(90 6.44 13.26)" />
    <rect width={4.9} height={1.09} x={9.98} y={12.71} fill="#f2f2f2" rx={0.26} transform="rotate(90 12.425 13.255)" />
    <ellipse cx={8.11} cy={8.06} fill="#f2f2f2" rx={1.04} ry={1.12} />
    <path fill="#3b3b3b" d="M2.11 12.25H.84a.34.34 0 0 1-.34-.3V6.09a.34.34 0 0 1 .34-.34h1.27z" />
  </svg>
)}
export default SvgNetworkInterfaces
