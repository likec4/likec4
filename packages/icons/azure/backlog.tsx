...
const SvgBacklog = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={3.439} x2={3.439} y1={6.801} y2={1.432} gradientUnits="userSpaceOnUse">
        <stop offset={0.2} stopColor="#0078d4" />
        <stop offset={0.287} stopColor="#1380da" />
        <stop offset={0.759} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="b" x1={3.439} x2={3.439} y1={11.998} y2={6.628} gradientUnits="userSpaceOnUse">
        <stop offset={0.2} stopColor="#0078d4" />
        <stop offset={0.287} stopColor="#1380da" />
        <stop offset={0.759} stopColor="#5ea0ef" />
      </linearGradient>
      <linearGradient id="c" x1={3.439} x2={3.439} y1={17.194} y2={11.824} gradientUnits="userSpaceOnUse">
        <stop offset={0.2} stopColor="#0078d4" />
        <stop offset={0.287} stopColor="#1380da" />
        <stop offset={0.759} stopColor="#5ea0ef" />
      </linearGradient>
