...
const SvgMonitorHealthModels = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Monitor-Health-Models_svg__a"
        x1={8.084}
        x2={8.084}
        y1={0}
        y2={15.296}
      ...
      <linearGradient
        id="Monitor-Health-Models_svg__b"
        x1={13.499}
        x2={13.499}
        y1={15.184}
        y2={12.028}
      ...
      <linearGradient
        id="Monitor-Health-Models_svg__c"
        x1={13.499}
        x2={13.499}
        y1={18.001}
        y2={15.298}
      ...
      <linearGradient
        id="Monitor-Health-Models_svg__d"
        x1={-550.47}
        x2={-550.47}
        y1={1016.012}
        y2={1013.31}
    ...
    <path
      fill="url(#Monitor-Health-Models_svg__a)"
    ...
    />
    <path
      fill="url(#Monitor-Health-Models_svg__b)"
    ...
    />
    <path
      fill="url(#Monitor-Health-Models_svg__c)"
    ...
    />
    <circle cx={13.53} cy={10.855} r={1.351} fill="url(#Monitor-Health-Models_svg__d)" />
  </svg>
)
