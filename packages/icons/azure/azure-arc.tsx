...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id={`c-${suffix}`} x1={3.555} x2={14.434} y1={9.326} y2={9.326} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
    ...
    <path fill={`url(#a-${suffix})`} d="M14.433 6.535zv5.193l-3.566 2.066V4.462z" />
    <path fill="#9cebff" d="m10.868 4.469 3.565 2.073L18 4.468l-3.567-2.073z" />
    <path
      fill="#50e6ff"
    ...
    <path fill="#32bedd" d="m10.868 13.794 3.566-2.059v4.132z" />
    <path fill={`url(#a-${suffix})`} d="M14.433 6.535zv5.193l-3.566 2.066V4.462z" />
    <path fill={`url(#b-${suffix})`} d="M3.567 6.541h-.001v5.193l3.566 2.067V4.469z" />
    <path
      fill={`url(#c-${suffix})`}
