...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id={`b-${suffix}`} x1={4.03} x2={4.03} y1={10.059} y2={2} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#86d633" />
        <stop offset={1} stopColor="#76bc2d" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={13.97} x2={13.97} y1={10.059} y2={2} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#86d633" />
        <stop offset={1} stopColor="#76bc2d" />
      </linearGradient>
    </defs>
    ...
    />
    <rect width={8.059} height={8.059} fill={`url(#a-${suffix})`} rx={0.6} />
    <rect width={8.059} height={8.059} y={9.941} fill={`url(#b-${suffix})`} rx={0.6} />
    <rect width={8.059} height={8.059} x={9.941} y={9.941} fill={`url(#c-${suffix})`} rx={0.6} />
    <path
      fill="#86d633"
