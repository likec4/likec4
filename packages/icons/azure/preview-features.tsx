...
const SvgPreviewFeatures = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <rect width={8.059} height={8.059} fill="url(#Preview-Features_svg__a)" rx={0.6} />
    <rect width={8.059} height={8.059} y={9.941} fill="url(#Preview-Features_svg__b)" rx={0.6} />
    <rect width={8.059} height={8.059} x={9.941} y={9.941} fill="url(#Preview-Features_svg__c)" rx={0.6} />
    <path
      fill="#86d633"
