...
const SvgDefenderEngineeringStation = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" {...props}>
    <path
      fill="url(#Defender-Engineering-Station_svg__a)"
    ...
    />
    <path
      fill="url(#Defender-Engineering-Station_svg__d)"
    ...
    <defs>
      <linearGradient
        id="Defender-Engineering-Station_svg__a"
        x1={9}
        x2={9}
        y1={12.513}
        y2={1.065}
      ...
      <linearGradient
        id="Defender-Engineering-Station_svg__b"
        x1={9.003}
        x2={9.003}
        y1={16.935}
        y2={12.512}
      ...
      <linearGradient
        id="Defender-Engineering-Station_svg__c"
        x1={3.951}
        x2={7.172}
        y1={7.685}
        y2={7.685}
      ...
      <linearGradient
        id="Defender-Engineering-Station_svg__d"
        x1={11.027}
        x2={14.247}
        y1={7.685}
        y2={7.685}
