...
const SvgBareMetalInfrastructure = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={13.08} y2={1.019} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={9.443} x2={9.443} y1={16.981} y2={14.094} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005ba1" />
    ...
    <rect width={5.122} height={2.887} x={6.882} y={14.094} fill="url(#b)" rx={1.443} />
  </svg>
)
