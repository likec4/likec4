...
const SvgMobileEngagement = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Mobile-Engagement_svg__a" x1={9} x2={9} y1={22.81} y2={-2.491} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="Mobile-Engagement_svg__b" x1={9} x2={9} y1={15.982} y2={1.522} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#d2ebff" />
        <stop offset={0.997} stopColor="#f0fffd" />
      </linearGradient>
    </defs>
    <rect width={10.777} height={18} x={3.612} fill="url(#Mobile-Engagement_svg__a)" rx={0.419} />
    ...
    <rect
      ...
      x={4.623}
      y={1.522}
      fill="url(#Mobile-Engagement_svg__b)"
      opacity={0.9}
      rx={0.201}
    />
