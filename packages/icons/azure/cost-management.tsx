...
const SvgCostManagement = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={1.48} y2={17.07} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={6.13} x2={11.87} y1={9.28} y2={9.28} gradientUnits="userSpaceOnUse">
