...
const SvgCostManagement = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Cost-Management_svg__a" x1={9} x2={9} y1={1.48} y2={17.07} gradientUnits="userSpaceOnUse">
    ...
    <path
      fill="url(#Cost-Management_svg__a)"
    ...
    />
    <path
      fill="url(#Cost-Management_svg__b)"
