...
const SvgEdgeManagement = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Edge-Management_svg__a" x1={8.9} x2={8.9} y1={1.31} y2={12.11} gradientUnits="userSpaceOnUse">
    ...
    <g data-name="Layer 1">
      <path
        fill="url(#Edge-Management_svg__a)"
      ...
      />
      <path
        fill="url(#Edge-Management_svg__b)"
...
export default SvgEdgeManagement
