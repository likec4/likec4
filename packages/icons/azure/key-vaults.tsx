...
const SvgKeyVaults = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <radialGradient id="Key-Vaults_svg__a" cx={9} cy={9} r={8.5} gradientUnits="userSpaceOnUse">
