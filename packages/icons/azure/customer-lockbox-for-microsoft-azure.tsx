...
const SvgCustomerLockboxForMicrosoftAzure = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={7.86} x2={7.86} y1={17.94} y2={5.72} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={1} stopColor="#b77af4" />
      </linearGradient>
      <linearGradient id="b" x1={7.87} x2={7.87} y1={9.28} y2={-1.85} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={1} stopColor="#b77af4" />
      </linearGradient>
    </defs>
    ...
    <circle cx={7.87} cy={4.78} r={4.13} fill="url(#b)" />
