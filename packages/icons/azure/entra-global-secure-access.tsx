...
const SvgEntraGlobalSecureAccess = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={0} x2={12.076} y1={9} y2={9} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={9} x2={9} y1={18} y2={0} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#225086" />
        <stop offset={1} stopColor="#0055c5" />
      </linearGradient>
      <linearGradient id="c" x1={13.5} x2={13.5} y1={18} y2={0} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#225086" />
    ...
    />
    <path fill="url(#c)" d="M9 0a27.85 27.85 0 0 1 0 18c4.937 0 9-4.063 9-9a9 9 0 0 0-9-9" />
  </svg>
)
