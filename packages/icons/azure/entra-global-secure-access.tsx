...
const SvgEntraGlobalSecureAccess = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Entra-Global-Secure-Access_svg__a"
        x1={0}
        x2={12.076}
        y1={9}
        y2={9}
      ...
      <linearGradient
        id="Entra-Global-Secure-Access_svg__b"
        x1={9}
        x2={9}
        y1={18}
        y2={0}
      ...
      <linearGradient
        id="Entra-Global-Secure-Access_svg__c"
        x1={13.5}
        x2={13.5}
        y1={18}
        y2={0}
    ...
    <circle cx={9} cy={9} r={9} fill="url(#Entra-Global-Secure-Access_svg__a)" />
    <path
      fill="url(#Entra-Global-Secure-Access_svg__b)"
    ...
    />
    <path
      fill="url(#Entra-Global-Secure-Access_svg__c)"
