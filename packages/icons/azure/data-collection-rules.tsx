...
const SvgDataCollectionRules = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Data-Collection-Rules_svg__a"
        x1={10.463}
        x2={10.463}
        y1={15.888}
        y2={-2.112}
      ...
      <linearGradient
        id="Data-Collection-Rules_svg__b"
        x1={7.179}
        x2={7.179}
        y1={0.537}
        y2={12.51}
    ...
    <rect width={14.7} height={18} x={3.113} fill="url(#Data-Collection-Rules_svg__a)" rx={0.6} />
    <rect width={13.985} height={7.291} x={0.187} y={1.867} fill="url(#Data-Collection-Rules_svg__b)" rx={0.541} />
    <path
      fill="#fff"
