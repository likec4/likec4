...
const SvgCommunityImages = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#Community-Images_svg__a)"
    ...
    />
    <ellipse cx={10.564} cy={8.989} fill="url(#Community-Images_svg__b)" rx={3.505} ry={3.511} />
    <rect width={10.912} height={16.825} y={0.588} fill="url(#Community-Images_svg__c)" rx={0.526} />
