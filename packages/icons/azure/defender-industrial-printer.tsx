...
const SvgDefenderIndustrialPrinter = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" {...props}>
    <g clipPath="url(#Defender-Industrial-Printer_svg__a)">
      <path
        fill="#005BA1"
      ...
      <path
        fill="url(#Defender-Industrial-Printer_svg__b)"
        d="M3.176 11.647h11.33v5.93a.455.455 0 0 1-.424.423H3.6a.455.455 0 0 1-.424-.424z"
      />
    </g>
    <defs>
      <linearGradient
        id="Defender-Industrial-Printer_svg__b"
        x1={8.839}
        x2={8.839}
        y1={18}
        y2={11.657}
      ...
      <clipPath id="Defender-Industrial-Printer_svg__a">
