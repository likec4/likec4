...
const SvgDefenderIndustrialPrinter = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" {...props}>
    <g clipPath="url(#a)">
      ...
      <path fill="url(#b)" d="M3.176 11.647h11.33v5.93a.455.455 0 0 1-.424.423H3.6a.455.455 0 0 1-.424-.424z" />
    </g>
    <defs>
      <linearGradient id="b" x1={8.839} x2={8.839} y1={18} y2={11.657} gradientUnits="userSpaceOnUse">
