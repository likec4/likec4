...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={8.14} x2={8.14} y1={6.52} y2={18.39} gradientUnits="userSpaceOnUse">
        <stop offset={0.22} stopColor="#32d4f5" />
        <stop offset={1} stopColor="#198ab3" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={7.8} x2={8.67} y1={0.15} y2={10.93} gradientUnits="userSpaceOnUse">
        <stop offset={0.22} stopColor="#32d4f5" />
        <stop offset={1} stopColor="#198ab3" />
      </linearGradient>
    </defs>
    ...
    <circle cx={8.15} cy={4.51} r={4.01} fill={`url(#b-${suffix})`} />
    <path
      fill="#b31b1b"
...
export default SvgTenantStatus
