...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={9} y1={-0.691} y2={19.486} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`b-${suffix}`} x1={9} x2={9} y1={17.788} y2={-0.966} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#5e9624" />
...
export default SvgAzureAttestation
