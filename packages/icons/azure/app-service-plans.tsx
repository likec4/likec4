...
const SvgAppServicePlans = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={5.57} x2={5.57} y1={17.5} y2={0.5} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={10.56} x2={10.56} y1={6.02} y2={19.71} gradientUnits="userSpaceOnUse">
