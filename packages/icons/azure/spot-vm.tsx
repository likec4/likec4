...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id={`c-${suffix}`} x1={9.029} x2={9.029} y1={0.189} y2={10.695} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#0078d4" />
        <stop offset={1} stopColor="#005ba1" />
      </linearGradient>
    </defs>
    <rect width={17.171} height={11.447} x={0.415} y={1.065} fill={`url(#a-${suffix})`} rx={0.548} />
    <path
      fill={`url(#b-${suffix})`}
      d="M12.443 15.975c-1.7-.265-1.764-1.49-1.759-3.463H7.316c0 1.973-.062 3.2-1.76 3.463a1 1 0 0 0-.846.96h8.59a1 1 0 0 0-.857-.96"
    />
    <circle cx={9.029} cy={6.685} r={4.045} fill={`url(#c-${suffix})`} />
