...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={8.56} x2={8.56} y1={17.59} y2={0.59} gradientUnits="userSpaceOnUse">
    ...
    <path fill={`url(#a-${suffix})`} d="M13.77 15.81A8.5 8.5 0 0 1 3.35 2.37l.09-.06a8.5 8.5 0 0 1 10.33 13.5" />
    <path
      fill="#fff"
