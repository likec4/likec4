...
const SvgTroubleshoot = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Troubleshoot_svg__a" x1={9} x2={9} y1={1} y2={17} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="Troubleshoot_svg__b" x1={8.96} x2={8.96} y1={1.1} y2={16.98} gradientUnits="userSpaceOnUse">
