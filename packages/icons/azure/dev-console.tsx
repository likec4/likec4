...
const SvgDevConsole = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Dev-Console_svg__a" x1={9} x2={9} y1={15.834} y2={5.788} gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#Dev-Console_svg__a)" d="M.5 5.788h17v9.478a.57.57 0 0 1-.568.568H1.068a.57.57 0 0 1-.568-.568z" />
