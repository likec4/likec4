...
const SvgVirtualInstanceForSap = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={9} x2={9} y1={12.48} y2={1.147} gradientUnits="userSpaceOnUse">
    ...
    <rect width={17} height={11.333} x={0.5} y={1.147} fill="url(#a)" rx={0.567} />
    <path
      fill="url(#b)"
    ...
    />
    <g fillRule="evenodd">
      <path fill="url(#c)" d="M2.427 10.028h6.788l6.643-6.644H2.427z" />
      <path
        fill="#fff"
