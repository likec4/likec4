...
const SvgVirtualInstanceForSap = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Virtual-Instance-for-SAP_svg__a"
        x1={9}
        x2={9}
        y1={12.48}
        y2={1.147}
      ...
      <linearGradient
        id="Virtual-Instance-for-SAP_svg__b"
        x1={9}
        x2={9}
        y1={684.663}
        y2={689.036}
      ...
      <linearGradient
        id="Virtual-Instance-for-SAP_svg__c"
        x1={0.003}
        x2={0.003}
        y1={-27.428}
        y2={-28.757}
    ...
    <rect width={17} height={11.333} x={0.5} y={1.147} fill="url(#Virtual-Instance-for-SAP_svg__a)" rx={0.567} />
    <path
      fill="url(#Virtual-Instance-for-SAP_svg__b)"
    ...
    />
    <g fillRule="evenodd">
      <path fill="url(#Virtual-Instance-for-SAP_svg__c)" d="M2.427 10.028h6.788l6.643-6.644H2.427z" />
      <path
        fill="#fff"
