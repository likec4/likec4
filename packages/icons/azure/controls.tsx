...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={3.524} x2={3.524} y1={6.162} y2={18} gradientUnits="userSpaceOnUse">
        <stop offset={0.17} stopColor="#50e6ff" />
        <stop offset={0.635} stopColor="#3dcdea" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={8.941} x2={8.941} y1={14.256} gradientUnits="userSpaceOnUse">
        <stop offset={0.17} stopColor="#50e6ff" />
        <stop offset={0.635} stopColor="#3dcdea" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
      <linearGradient id={`c-${suffix}`} x1={14.444} x2={14.444} y1={6.162} gradientUnits="userSpaceOnUse">
        <stop offset={0.17} stopColor="#50e6ff" />
        <stop offset={0.635} stopColor="#3dcdea" />
        <stop offset={1} stopColor="#32bedd" />
      </linearGradient>
    ...
    <rect width={2.494} height={11.838} x={2.276} y={6.162} fill={`url(#a-${suffix})`} rx={0.596} />
    <rect width={2.494} height={3.744} x={7.693} y={14.256} fill={`url(#b-${suffix})`} rx={0.596} />
    <rect width={2.494} height={11.838} x={13.197} y={6.162} fill={`url(#c-${suffix})`} rx={0.596} />
