...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={9} x2={15.8} y1={9} y2={9} gradientUnits="userSpaceOnUse">
    ...
    />
    <path fill="#005ba1" d="M16.85 3.42H9v13h7.88a.65.65 0 0 0 .65-.65V4.07a.65.65 0 0 0-.68-.65" />
    <path
      fill="#f2f2f2"
