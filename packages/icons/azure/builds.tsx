...
const SvgBuilds = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient id="Builds_svg__b" x1={9} x2={9} y1={17.466} y2={12.672} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#773adc" />
        <stop offset={0.735} stopColor="#a67af4" />
      </linearGradient>
    </defs>
    <path
      fill="url(#Builds_svg__a)"
    ...
    />
    <rect width={17} height={4.793} x={0.5} y={12.672} fill="url(#Builds_svg__b)" rx={0.513} />
    <g fill="#86d633">
