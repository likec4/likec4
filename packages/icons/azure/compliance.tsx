...
const SvgCompliance = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="Compliance_svg__a" x1={9} x2={9} y1={17.5} y2={0.5} gradientUnits="userSpaceOnUse">
