...
const SvgDeviceConfiguration = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={6.36} x2={6.36} y1={22.03} y2={-1.85} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="b" x1={6.36} x2={6.36} y1={15.58} y2={1.94} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#d2ebff" />
        <stop offset={1} stopColor="#f0fffd" />
      </linearGradient>
    </defs>
    <rect width={10.17} height={16.99} x={1.28} y={0.5} fill="url(#a)" rx={0.51} />
    ...
    <rect width={8.26} height={13.65} x={2.23} y={1.94} fill="url(#b)" opacity={0.9} rx={0.19} />
    <path
      fill="#949494"
