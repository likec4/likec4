...
const SvgDeviceConfiguration = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="Device-Configuration_svg__a"
        x1={6.36}
        x2={6.36}
        y1={22.03}
        y2={-1.85}
      ...
      <linearGradient
        id="Device-Configuration_svg__b"
        x1={6.36}
        x2={6.36}
        y1={15.58}
        y2={1.94}
    ...
    <rect width={10.17} height={16.99} x={1.28} y={0.5} fill="url(#Device-Configuration_svg__a)" rx={0.51} />
    ...
    <rect
      ...
      x={2.23}
      y={1.94}
      fill="url(#Device-Configuration_svg__b)"
      opacity={0.9}
      rx={0.19}
    />
    <path
