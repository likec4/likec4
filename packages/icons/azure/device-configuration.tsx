...
const SvgDeviceConfiguration = (props: SVGProps<SVGSVGElement>) => {
const suffix = randomString(6)
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={6.36} x2={6.36} y1={22.03} y2={-1.85} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`b-${suffix}`} x1={6.36} x2={6.36} y1={15.58} y2={1.94} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#d2ebff" />
        <stop offset={1} stopColor="#f0fffd" />
      </linearGradient>
    </defs>
    <rect width={10.17} height={16.99} x={1.28} y={0.5} fill={`url(#a-${suffix})`} rx={0.51} />
    <rect width={1.14} height={0.97} x={5.79} y={16.16} fill="#f2f2f2" rx={0.27} />
    <rect width={2.34} height={0.31} x={5.19} y={1.07} fill="#f2f2f2" rx={0.14} />
    <rect width={8.26} height={13.65} x={2.23} y={1.94} fill={`url(#b-${suffix})`} opacity={0.9} rx={0.19} />
    <path
      fill="#949494"
    ...
    />
    <circle cx={12.38} cy={13.04} r={1.4} fill="#fff" transform="rotate(-67.17 12.375 13.046)" />
  </svg>
)}
export default SvgDeviceConfiguration
