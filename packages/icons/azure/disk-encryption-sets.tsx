...
const SvgDiskEncryptionSets = (props: SVGProps<SVGSVGElement>) => {
...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <ellipse cx={8.38} cy={5.05} fill={`url(#a-${suffix})`} rx={5.54} ry={2.28} />
    ...
    <g fill="#c3f1ff">
      <path
        ...
        opacity={0.75}
      />
      <rect width={2.89} height={0.34} x={11.7} y={9.79} opacity={0.75} rx={0.16} />
      <rect width={2.89} height={0.34} x={11.7} y={10.35} opacity={0.75} rx={0.16} />
    </g>
    <path
      fill="#5e9624"
...
export default SvgDiskEncryptionSets
