...
const SvgAppSpace = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36" {...props}>
    <g clipPath="url(#App-Space_svg__a)">
      <path
        fill="url(#App-Space_svg__b)"
    ...
    <defs>
      <linearGradient id="App-Space_svg__b" x1={18} x2={18} y1={2} y2={38} gradientUnits="userSpaceOnUse">
        <stop stopColor="#5EA0EF" />
        <stop offset={1} stopColor="#0078D4" />
      </linearGradient>
      <clipPath id="App-Space_svg__a">
