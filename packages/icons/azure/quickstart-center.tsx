...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={8.47} x2={14.96} y1={2.89} y2={9.62} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`b-${suffix}`} x1={6.86} x2={-0.99} y1={11.19} y2={18.81} gradientUnits="userSpaceOnUse">
    ...
    <path fill="#d15900" d="M5.16 13.59a3 3 0 0 1-1.33.59 3.3 3.3 0 0 1 .58-1.34L8 9.24l.75.75Z" />
  </svg>
)}
export default SvgQuickstartCenter
