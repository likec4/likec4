...
const SvgOperationLogClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient id="a" x1={8.15} x2={8.15} y1={17.5} y2={2.09} gradientUnits="userSpaceOnUse">
...
export default SvgOperationLogClassic
