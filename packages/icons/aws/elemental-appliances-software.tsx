...
const SvgElementalAppliancesSoftware = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" {...props}>
    <defs>
      <linearGradient id="Elemental-Appliances-&amp;-Software_svg__a" x1="0%" x2="100%" y1="100%" y2="0%">
        <stop offset="0%" stopColor="#C8511B" />
        <stop offset="100%" stopColor="#F90" />
      </linearGradient>
    </defs>
    <g fill="none" fillRule="evenodd">
      <path fill="url(#Elemental-Appliances-&amp;-Software_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
export default SvgElementalAppliancesSoftware
