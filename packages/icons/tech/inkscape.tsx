...
const SvgInkscape = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 128 128" {...props}>
    <g transform="translate(.389 -1.445)scale(.994)">
      ...
      <g clipPath="url(#b)" transform="translate(.605 .604)scale(.991)">
        <linearGradient
          id="c"
          x1={98.293}
          x2={74.286}
      ...
      <path fill="url(#d)" d="M12.5 57.3C.3 69.3 21.7 66 38.1 72.4l34-59.7c-5.1-5.3-11.7-4.8-16.4 0z" opacity={0.505} />
      <linearGradient
        id="e"
        x1={48.612}
        x2={81.173}
      ...
      <path fill="url(#h)" d="M87.2 84.9c21.3-7.8 28.2-8.9 35.2-16C114.2 75.8 97 79.5 83 85.6z" opacity={0.453} />
      <g opacity={0.512}>
        <radialGradient
          id="i"
          cx={-45.82}
        ...
        <path fill="url(#i)" d="M87.2 83.9c35.1-12.4 29.2-12.4 35.2-16-11.2 4.3-32 4.7-39.4 16.7z" />
      </g>
      <linearGradient
        id="j"
        x1={-32.429}
      ...
      <path fill="url(#l)" d="M104.9 97.1c2.2 2 14.2 3 16.2-.6-3.9 2.8-12.5 1.8-16.2.6" />
      <linearGradient
        id="m"
        x1={-643.912}
        x2={-643.777}
      ...
      <g opacity={0.621}>
        ...
        <path fill="url(#n)" d="M105.8 104.2c.7 1.3.3 2.8-.9 3.4s-2.6 0-3.3-1.3-.3-2.8.9-3.4 2.6 0 3.3 1.3" />
      </g>
      <radialGradient
        id="o"
        cx={-645.599}
      ...
      <path fill="url(#o)" d="M101.9 107.8c1.7 1.4 8.3 1.5 5.8-2.4.7 3.1-3.8 2.8-5.8 2.4" />
      <radialGradient
        id="p"
        cx={-185.187}
        cy={69.66}
      ...
      <path fill="url(#p)" d="M21 87.3c0-.3 22.4 6.8 26.2 10.7-3.1-3.1-19.1-10.1-21.5-10.2s-4.4-.3-4.7-.5" />
      <g transform="matrix(.879 -.193 .234 .696 -20.21 36.726)">
        ...
        <g opacity={0.621}>
          ...
          <path fill="url(#r)" d="M39.6 106.9c0 1.7-2.8 3-6.1 3s-6.1-1.4-6.1-3c0-1.7 2.8-3 6.1-3s6.1 1.3 6.1 3" />
        </g>
      </g>
      <g opacity={0.616}>
        <radialGradient
      ...
      <path fill="url(#x)" d="M34.3 78.5c-7.8 4.8-19.8 6.5-6.6 9.7-1.6-3.5 3.4-3.1 6.6-9.7" opacity={0.251} />
      <g opacity={0.363}>
        <linearGradient
          id="y"
          x1={-115.448}
