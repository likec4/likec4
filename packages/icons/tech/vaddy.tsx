...
const SvgVaddy = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 254" {...props}>
    <defs>
      <linearGradient id="vaddy_svg__a" x1="50%" x2="50%" y1="-1.02%" y2="100%">
        <stop offset="0%" stopColor="#8FC53B" />
        <stop offset="100%" stopColor="#48A23C" />
      </linearGradient>
    </defs>
    <path
      fill="url(#vaddy_svg__a)"
