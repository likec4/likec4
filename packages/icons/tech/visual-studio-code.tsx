...
const SvgVisualStudioCode = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <linearGradient id="visual-studio-code_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
    ...
    <mask id="visual-studio-code_svg__b" fill="#fff">
      <use xlinkHref="#visual-studio-code_svg__a" />
    </mask>
    <path
      fill="#0065A9"
      ...
      mask="url(#visual-studio-code_svg__b)"
    />
    <path
      fill="#007ACC"
    ...
    />
    <path
      fill="url(#visual-studio-code_svg__c)"
      fillOpacity={0.25}
