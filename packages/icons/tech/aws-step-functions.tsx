...
const SvgAwsStepFunctions = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256" {...props}>
    <defs>
      <linearGradient id="aws-step-functions_svg__a" x1="0%" x2="100%" y1="100%" y2="0%">
        <stop offset="0%" stopColor="#B0084D" />
        <stop offset="100%" stopColor="#FF4F8B" />
      </linearGradient>
    </defs>
    <path fill="url(#aws-step-functions_svg__a)" d="M0 0h256v256H0z" />
    <path
      fill="#FFF"
...
export default SvgAwsStepFunctions
