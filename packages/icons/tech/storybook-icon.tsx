...
const SvgStorybookIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <mask id="storybook-icon_svg__b" fill="#fff">
      <use xlinkHref="#storybook-icon_svg__a" />
    </mask>
    <use xlinkHref="#storybook-icon_svg__a" fill="#FF4785" />
    <path
      fill="#FFF"
      ...
      mask="url(#storybook-icon_svg__b)"
    />
  </svg>
)
