...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path fill={`url(#a-${suffix})`} d="m70.082 27.281-3.898-11.8-40.73-8.778-19.97 22.59L27.43 40.52V27.28Zm0 0" />
    <path fill={`url(#b-${suffix})`} d="M27.43 34.96 5.484 29.294l11.157 67 10.75-.086Zm0 0" />
    <path fill={`url(#c-${suffix})`} d="M100.57 27.281H62.402l15.336-13.629 29.551 5.489 15.227 37.836-21.934 21.785Zm0 0" />
    <path fill={`url(#d-${suffix})`} d="m100.598 56.477-.028 43.949H37.742l1.621 9.558 39.45 13.75 43.703-26.16Zm0 0" />
