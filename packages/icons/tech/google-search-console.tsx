...
const SvgGoogleSearchConsole = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 228" {...props}>
    ...
    <path fill="#737373" d="M165.98 0H90.02L71.098 19.055V37.98H90.02V19.055h75.958V37.98h18.924V19.055z" />
    <path fill="#BFBFBF" d="M90.02 0v19.055h75.96V0z" />
    <path
      fill="url(#google-search-console_svg__a)"
    ...
    <path fill="#E0E0E0" d="M36.402 37.98 0 74.381v34.694h256V74.513L219.466 37.98z" />
...
export default SvgGoogleSearchConsole
