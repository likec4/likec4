...
const SvgBrowserstack = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256" {...props}>
    <defs>
      <radialGradient id="browserstack_svg__a" cx="50.141%" cy="50.003%" r="50.119%" fx="50.141%" fy="50.003%">
    ...
    <circle cx={129.331} cy={104.837} r={44.768} fill="url(#browserstack_svg__a)" />
    <circle cx={129.331} cy={104.837} r={44.768} fill="#231F20" />
    <path
      fill="#FFF"
      d="M141.088 98.971c4.439 1.992 10.56-2.016 13.672-8.951s2.036-14.173-2.402-16.164c-4.44-1.992-10.56 2.016-13.672 8.951s-2.037 14.173 2.402 16.164"
    />
  </svg>
)
