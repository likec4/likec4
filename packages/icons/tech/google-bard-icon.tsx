...
const SvgGoogleBardIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 258" {...props}>
    <defs>
      <radialGradient
        id="google-bard-icon_svg__a"
        cx="78.302%"
        cy="55.52%"
        r="78.115%"
        fx="78.302%"
    ...
    <path
      fill="url(#google-bard-icon_svg__a)"
    ...
    />
    <path
      fill="url(#google-bard-icon_svg__b)"
...
export default SvgGoogleBardIcon
