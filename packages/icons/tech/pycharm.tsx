...
const SvgPycharm = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <linearGradient id="Pycharm-_svg__a" x1={38.78} x2={95.91} y1={41.59} y2={41.59} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#21d789" />
      <stop offset={1} stopColor="#07c3f2" />
    </linearGradient>
    <linearGradient id="Pycharm-_svg__b" x1={-29.18} x2={88.46} y1={85.52} y2={-1.32} gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="Pycharm-_svg__c" x1={17.3} x2={36.92} y1={110.99} y2={49.42} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#21d789" />
    ...
    <linearGradient id="Pycharm-_svg__d" x1={43.28} x2={85.97} y1={57.46} y2={0.06} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#21d789" />
    ...
    <linearGradient id="Pycharm-_svg__e" x1={108.58} x2={22.55} y1={64.77} y2={63.97} gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#Pycharm-_svg__a)" d="m87.54 23.954 34.194 28.44-12.312 25.051-20.614-5.717H70.973z" />
    <path
      fill="url(#Pycharm-_svg__b)"
      d="m53.09 42.423-6.619 35.023-.634 11.898-16.689 7.229-23.662 2.548 7.18-75.666L55.54 5.486l26.417 17.323z"
    />
    <path fill="url(#Pycharm-_svg__c)" d="m53.09 42.423 3.218 67.486-10.691 12.605L5.486 99.121l32.951-49.103z" />
    <path fill="url(#Pycharm-_svg__d)" d="M97.243 37.498H56.698L92.526 5.486z" />
    <path
      fill="url(#Pycharm-_svg__e)"
