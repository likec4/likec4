...
const SvgXcode = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <linearGradient id="a" x1={63.947} x2={63.947} y1={114.165} y2={13.784} gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="b" x1={94.037} x2={94.037} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="c" x1={89.042} x2={89.042} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="d" x1={63.947} x2={63.947} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path fill="url(#d)" d="M63.7 72.2h.5v7.5h-.5z" />
    <linearGradient id="e" x1={58.952} x2={58.952} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path fill="url(#e)" d="M58.8 72.2h.5s-.2 1.9-.2 3.9c0 1.8.2 3.6.2 3.6h-.5s-.2-1.8-.2-3.6c0-2 .2-3.9.2-3.9" />
    <linearGradient id="f" x1={53.958} x2={53.958} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path fill="url(#f)" d="M54 72.2h.5s-.5 1.9-.5 3.9c0 1.8.5 3.6.5 3.6H54s-.5-1.8-.5-3.6c0-2 .5-3.9.5-3.9" />
    <linearGradient id="g" x1={48.963} x2={48.963} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path fill="url(#g)" d="M49.1 72.2h.5s-.7 1.9-.7 3.9c0 1.8.7 3.6.7 3.6h-.5s-.7-1.8-.7-3.6c0-2 .7-3.9.7-3.9" />
    <linearGradient id="h" x1={43.968} x2={43.968} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path fill="url(#h)" d="M44.2 72.2h.5s-1 1.6-1 3.9c0 2 1 3.6 1 3.6h-.5s-1-1.6-1-3.6c0-2.3 1-3.9 1-3.9" />
    <linearGradient id="i" x1={38.852} x2={38.852} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="j" x1={33.857} x2={33.857} y1={79.666} y2={72.184} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1492e7" />
      <stop offset={1} stopColor="#dbedfb" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="k" x1={73.58} x2={73.58} y1={94.25} y2={32.642} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="l" x1={87.464} x2={54.081} y1={93.978} y2={36.156} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#2b90e7" />
      <stop offset={1} stopColor="#00b6ef" />
    </linearGradient>
    <path fill="url(#l)" d="M54.2 36.7 87 93.6l.2.1.2.1.2.1-33.4-57.8z" />
    <linearGradient id="m" x1={89.073} x2={54.583} y1={94.327} y2={34.589} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#3795ea" />
      <stop offset={1} stopColor="#49c4f2" />
    </linearGradient>
    <path fill="url(#m)" d="m54.5 34.8 34.3 59.4h.4L54.7 34.5l-.1.2z" />
    <linearGradient id="n" x1={91.026} x2={56.072} y1={93.735} y2={33.193} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#3696ea" />
      <stop offset={1} stopColor="#90d9f6" />
    </linearGradient>
    <path fill="url(#n)" d="m55.9 33.3 35 60.5.3-.2-35-60.5z" />
    <linearGradient id="o" x1={92.582} x2={58.065} y1={92.332} y2={32.547} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#3097ea" />
      <stop offset={1} stopColor="#b5e5f9" />
    </linearGradient>
    <path fill="url(#o)" d="M58.4 32.7 92.6 92l-.1.2-.1.2-34.5-59.8h.2z" />
    <linearGradient id="p" x1={93.083} x2={59.741} y1={90.686} y2={32.936} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#3a98ea" />
      <stop offset={1} stopColor="#bce7fa" />
    </linearGradient>
    <path fill="url(#p)" d="M60.2 33.3 93 90.1v.6L59.6 33l.2.1.2.1z" />
    <path
      fill="#3c98ea"
    ...
    <linearGradient id="q" x1={67.981} x2={74.457} y1={61.226} y2={57.487} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="r" x1={65.487} x2={71.962} y1={56.906} y2={53.167} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#00a4ec" />
      <stop offset={1} stopColor="#b9dff6" />
    </linearGradient>
    <path
    ...
    <linearGradient id="s" x1={57.93} x2={64.364} y1={43.819} y2={40.105} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="t" x1={55.424} x2={61.9} y1={39.477} y2={35.738} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#00b4ef" />
      <stop offset={1} stopColor="#c3e9fa" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="u" x1={54.566} x2={54.566} y1={94.401} y2={32.794} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1285e7" />
      <stop offset={1} stopColor="#00b5ef" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="v" x1={40.681} x2={74.064} y1={94.131} y2={36.311} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#3194e9" />
      <stop offset={1} stopColor="#71cff4" />
    </linearGradient>
    <path fill="url(#v)" d="M54.1 71.3 74 36.9v-.6s-11 19.1-20.2 35zm-5.4 9.2-7.6 13.2-.3.2-.3.1s3.4-5.9 7.8-13.5z" />
    <linearGradient id="w" x1={39.063} x2={73.557} y1={94.482} y2={34.736} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="x" x1={37.118} x2={72.072} y1={93.885} y2={33.343} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="y" x1={35.568} x2={70.085} y1={92.482} y2={32.697} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="z" x1={35.056} x2={68.415} y1={90.872} y2={33.092} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#5aa6ec" />
    ...
    />
    <linearGradient id="A" x1={66.362} x2={72.838} y1={35.689} y2={39.428} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#c1e7fa" />
      <stop offset={1} stopColor="#89d4f5" />
    </linearGradient>
    <path fill="url(#A)" d="m66 36.2-.2.4s1.8-.9 4.2.4c2.2 1.2 2.3 3.3 2.3 3.3l.2-.4s.2-1.9-2.3-3.3-4.2-.4-4.2-.4" />
    <linearGradient id="B" x1={63.856} x2={70.332} y1={40.03} y2={43.768} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#c1e7fa" />
      <stop offset={1} stopColor="#89d4f5" />
    </linearGradient>
    <path fill="url(#B)" d="m63.6 40.5-.2.4s2-.6 4.1.6c2 1.1 2.4 3 2.4 3l.2-.4s-.2-1.8-2.4-3c-2.3-1.3-4.1-.6-4.1-.6" />
    <linearGradient id="C" x1={61.273} x2={67.748} y1={44.505} y2={48.243} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#c1e7fa" />
      <stop offset={1} stopColor="#89d4f5" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="D" x1={58.761} x2={65.236} y1={48.855} y2={52.594} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="E" x1={56.25} x2={62.727} y1={53.204} y2={56.943} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="F" x1={53.74} x2={60.215} y1={57.553} y2={61.291} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#b4def8" />
      <stop offset={1} stopColor="#4eb5f0" />
    </linearGradient>
    <path fill="url(#F)" d="m53.8 57.4-.3.4s1.8.7 3.5 1.7c1.6.9 3 2 3 2l.2-.4s-1.4-1.1-3-2-3.4-1.7-3.4-1.7" />
    <linearGradient id="G" x1={51.239} x2={57.713} y1={61.886} y2={65.624} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#b5ddf8" />
      <stop offset={1} stopColor="#46aeee" />
    </linearGradient>
    <path fill="url(#G)" d="m51.1 62.1.2-.4 6.5 3.7-.2.4z" />
    <linearGradient id="H" x1={48.735} x2={55.211} y1={66.22} y2={69.959} gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="I" x1={42.719} x2={47.681} y1={80.135} y2={83} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#8fc1f2" />
      <stop offset={1} stopColor="#3193ea" />
    </linearGradient>
    <path fill="url(#I)" d="M43.2 80.5c.4.3.8.6 1.3.9 1.8 1 3.6.9 3.6.9l-.2.4s-1.8.1-3.6-.9c-.7-.4-1.3-.9-1.7-1.3z" />
    <linearGradient id="J" x1={38.634} x2={45.11} y1={83.717} y2={87.456} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#8fc1f2" />
      <stop offset={1} stopColor="#3193ea" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="K" x1={36.124} x2={42.599} y1={88.063} y2={91.802} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#8fc1f2" />
      <stop offset={1} stopColor="#3193ea" />
    </linearGradient>
    <path
    ...
    />
    <linearGradient id="L" x1={76.722} x2={89.179} y1={64.933} y2={71.008} gradientUnits="userSpaceOnUse">
      <stop offset={0.001} />
      <stop offset={1} stopOpacity={0} />
    </linearGradient>
    <path fill="url(#L)" d="m68.8 114.2 42.8-89.9-10.8-5.1-44.6 93.5s1.4.7 3.2 1.5z" />
    <radialGradient
      id="M"
      cx={95.237}
      cy={25.132}
    ...
    <path fill="url(#M)" d="m94.1 13.8 20 9.5V52C107.2 48.7 61 26.7 61 26.7s3.2-6.7 6.2-12.9z" />
    <radialGradient
      id="N"
      cx={51.211}
      cy={114.953}
    ...
    />
    <linearGradient id="O" x1={84.758} x2={94.522} y1={39.174} y2={44.149} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="P" x1={117.884} x2={106.863} y1={29.257} y2={14.364} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="Q" x1={98.542} x2={114.815} y1={30.424} y2={28.322} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="R" x1={106.128} x2={104.549} y1={31.808} y2={22.854} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="S" x1={58.131} x2={73.237} y1={81.721} y2={89.154} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="T" x1={81.508} x2={93.19} y1={31.679} y2={6.047} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="U" x1={69.064} x2={91.026} y1={16.837} y2={16.837} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="V" x1={69.064} x2={88.054} y1={11.697} y2={11.697} gradientUnits="userSpaceOnUse">
    ...
    />
    <linearGradient id="W" x1={116.332} x2={123.707} y1={34.756} y2={21.982} gradientUnits="userSpaceOnUse">
