...
const SvgWeave = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 261" {...props}>
    <path
      fill="#FF4B19"
    ...
    />
    <path fill="#FF4B19" d="M35.794 180.727v9.177l38.05-34.361V10.899c-14.196 6.207-27.036 14.888-38.05 25.475z" />
  </svg>
)
export default SvgWeave
