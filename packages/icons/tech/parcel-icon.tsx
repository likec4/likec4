...
const SvgParcelIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 193" {...props}>
    <defs>
      <linearGradient id="parcel-icon_svg__a" x1="49.385%" x2="50.286%" y1="49.503%" y2="50.417%">
        <stop offset="0%" />
        <stop offset="100%" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__b" x1="50.147%" x2="49.946%" y1="49.935%" y2="50.142%">
        <stop offset="0%" />
        <stop offset="100%" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__c" x1="81.503%" x2="93.734%" y1="46.547%" y2="50.202%">
        <stop offset="0%" stopColor="#C37A44" />
        <stop offset="44.42%" stopColor="#BB713D" />
        <stop offset="64.06%" stopColor="#A05728" />
        <stop offset="100%" stopColor="#964E23" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__d" x1="63.475%" x2="41.388%" y1="61.32%" y2="43.414%">
        <stop offset="0%" stopColor="#E9B880" />
        <stop offset="100%" stopColor="#E4AF76" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__e" x1="50.894%" x2="49.16%" y1="51.117%" y2="49.274%">
        <stop offset="0%" stopColor="#C37A45" stopOpacity={0} />
        <stop offset="13.34%" stopColor="#C37A45" />
        <stop offset="29.45%" stopColor="#D08D55" />
        <stop offset="50.21%" stopColor="#DEA167" />
        <stop offset="69.66%" stopColor="#E8AF73" />
        <stop offset="86.31%" stopColor="#ECB477" />
        <stop offset="100%" stopColor="#ECB477" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__f" x1="47.423%" x2="22.315%" y1="28.937%" y2="77.493%">
        <stop offset="8.81%" stopColor="#AF6938" />
        <stop offset="48.29%" stopColor="#9A5227" />
        <stop offset="77.92%" stopColor="#8D4520" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__g" x1="41.147%" x2="56.579%" y1="57.288%" y2="44.95%">
        <stop offset="3.27%" stopColor="#E4AF76" />
        <stop offset="100%" stopColor="#E9B880" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__h" x1="49.624%" x2="50.677%" y1="50.47%" y2="49.223%">
        <stop offset="0%" stopColor="#AF6A38" stopOpacity={0} />
        <stop offset="8.6%" stopColor="#AF6A38" />
        <stop offset="19.77%" stopColor="#B87542" />
        <stop offset="58.28%" stopColor="#D59C66" />
        <stop offset="77.71%" stopColor="#E4AF76" />
        <stop offset="92.39%" stopColor="#E4AF76" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__i" x1="8.211%" x2="93.243%" y1="50.006%" y2="50.006%">
        <stop offset="0%" stopColor="#743F1A" stopOpacity={0} />
        <stop offset="49.29%" stopColor="#743F1A" stopOpacity={0.887} />
        <stop offset="50%" stopColor="#743F1A" stopOpacity={0.9} />
        <stop offset="52.97%" stopColor="#743F1A" stopOpacity={0.847} />
        <stop offset="100%" stopColor="#743F1A" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__j" x1="49.901%" x2="49.998%" y1="50.091%" y2="49.994%">
        <stop offset="0%" stopColor="#322214" />
        <stop offset="23.97%" stopColor="#322314" stopOpacity={0.989} />
        <stop offset="100%" stopColor="#322214" stopOpacity={0} />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__k" x1="51.38%" x2="48.714%" y1="48.236%" y2="51.568%">
        <stop offset="4.76%" stopColor="#C69866" />
        <stop offset="41.56%" stopColor="#BA8C5E" />
        <stop offset="81.35%" stopColor="#B5875B" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__l" x1="63.039%" x2="24.984%" y1="46.844%" y2="8.907%">
        <stop offset="0%" stopColor="#845F35" />
        <stop offset="43.11%" stopColor="#91673C" />
        <stop offset="44.07%" stopColor="#976A40" />
        <stop offset="87.37%" stopColor="#986B40" />
        <stop offset="100%" stopColor="#AB8157" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__m" x1="49.999%" x2="50.108%" y1="50.004%" y2="50.114%">
        <stop offset="0%" stopColor="#322214" stopOpacity={0} />
        <stop offset="100%" stopColor="#322214" />
      </linearGradient>
      <linearGradient id="parcel-icon_svg__n" x1="45.656%" x2="50.475%" y1="62.623%" y2="33.538%">
        <stop offset="0%" stopColor="#A9794B" />
        <stop offset="38.57%" stopColor="#AE7F53" />
        <stop offset="45.57%" stopColor="#AC7D50" />
        <stop offset="62.36%" stopColor="#A9794B" />
        <stop offset="100%" stopColor="#B2875D" />
      </linearGradient>
    </defs>
    <path
      fill="url(#parcel-icon_svg__a)"
      d="m140.515 191.333 70.257-44.428c.26-.16.6-.09.76.17s.09.6-.17.76l-70.487 44.568c-.09.06-.19.09-.29.09z"
    />
    <path
      fill="url(#parcel-icon_svg__b)"
    ...
    />
    <path fill="url(#parcel-icon_svg__c)" d="M119.585 84.367h-.01l-14.58-9.45-41.097-10.539 55.257-19.87.15-.29v.29z" />
    <path
      fill="url(#parcel-icon_svg__d)"
