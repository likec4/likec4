...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path fill={`url(#a-${suffix})`} d="M47.555 51.25 50.09 5.484l26.613 14.75Zm0 0" />
    <path fill={`url(#b-${suffix})`} d="M47.555 51.25 50.09 5.484 16.297 26.781 5.484 91.527Zm0 0" />
    <path
      fill={`url(#c-${suffix})`}
      d="m120.188 40.559-15.06-30.61-28.425 10.285L47.555 51.25 5.485 91.527l37.949 27.621 47.703-43.02Zm0 0"
    />
    <path fill={`url(#d-${suffix})`} d="M100.57 72.582v27.988H54.613l20.2 15.63 29.257 6.316 18.446-41.754Zm0 0" />
