...
const SvgCustomerioIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 180" {...props}>
    <path fill="#FFCD00" d="M127.843 102.423a51.21 51.21 0 1 0-51.21-51.186 51.186 51.186 0 0 0 51.21 51.186" />
    <path
      fill="#00ECBB"
...
export default SvgCustomerioIcon
