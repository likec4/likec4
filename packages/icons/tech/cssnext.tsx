...
const SvgCssnext = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 311" {...props}>
    <defs>
      <linearGradient id="cssnext_svg__a" x1="50.002%" x2="50.002%" y1=".003%" y2="100%">
        <stop offset="0%" stopColor="#5C70B5" />
        <stop offset="67.5%" stopColor="#507DBF" />
        <stop offset="100%" stopColor="#428BCA" />
      </linearGradient>
      <linearGradient id="cssnext_svg__b" x1="49.999%" x2="49.999%" y1="-27.14%" y2="124.765%">
        <stop offset="0%" stopColor="#5C70B5" />
        <stop offset="67.5%" stopColor="#507DBF" />
        <stop offset="100%" stopColor="#428BCA" />
      </linearGradient>
      <linearGradient id="cssnext_svg__c" x1="50.01%" x2="50.01%" y1="-36.855%" y2="134.212%">
        <stop offset="0%" stopColor="#5C70B5" />
        <stop offset="67.5%" stopColor="#507DBF" />
        <stop offset="100%" stopColor="#428BCA" />
      </linearGradient>
      <linearGradient id="cssnext_svg__d" x1="49.998%" x2="49.998%" y1="-45.87%" y2="142.961%">
        <stop offset="0%" stopColor="#5C70B5" />
        <stop offset="67.5%" stopColor="#507DBF" />
        <stop offset="100%" stopColor="#428BCA" />
      </linearGradient>
      <linearGradient id="cssnext_svg__e" x1="49.998%" x2="49.998%" y1="-62.79%" y2="159.334%">
        <stop offset="0%" stopColor="#5C70B5" />
        <stop offset="67.5%" stopColor="#507DBF" />
        <stop offset="100%" stopColor="#428BCA" />
      </linearGradient>
