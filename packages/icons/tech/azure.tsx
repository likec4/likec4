...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <defs>
      <linearGradient id={`a-${suffix}`} x1={60.919} x2={18.667} y1={9.602} y2={134.423} gradientUnits="userSpaceOnUse">
        <stop stopColor="#114A8B" />
        <stop offset={1} stopColor="#0669BC" />
      </linearGradient>
      <linearGradient id={`b-${suffix}`} x1={74.117} x2={64.344} y1={67.772} y2={71.076} gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id={`c-${suffix}`} x1={68.742} x2={115.122} y1={5.961} y2={129.525} gradientUnits="userSpaceOnUse">
