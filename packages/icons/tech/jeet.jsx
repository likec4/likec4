...
const SvgJeet = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 128 128" {...props}>
    ...
    <path fill="url(#c)" d="m148.662 80.175-60.226 69.57L18.864 89.52 79.09 19.948z" clipPath="url(#b)" />
    <defs>
      <path
        id="d"
    ...
    <path fill="url(#f)" d="m46.572 18.83 63.58 66.812-66.812 63.58-63.58-66.813z" clipPath="url(#e)" />
    <defs>
      <path
        id="g"
    ...
    <path fill="url(#i)" d="m-20.698 43.742 64.675-65.79 65.79 64.675-64.674 65.79z" clipPath="url(#h)" />
    <defs>
      <path
        id="j"
    ...
    <path fill="url(#l)" d="M83.834 109.235 17.652 44.972 81.916-21.21l66.182 64.264z" clipPath="url(#k)" />
    <path
      fill="#FFC800"
