...
const SvgSupabaseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 263" {...props}>
    <defs>
      <linearGradient id="supabase-icon_svg__a" x1="20.862%" x2="63.426%" y1="20.687%" y2="44.071%">
        <stop offset="0%" stopColor="#249361" />
        <stop offset="100%" stopColor="#3ECF8E" />
      </linearGradient>
      <linearGradient id="supabase-icon_svg__b" x1="1.991%" x2="21.403%" y1="-13.158%" y2="34.708%">
        <stop offset="0%" />
