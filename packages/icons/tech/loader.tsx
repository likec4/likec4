...
const SvgLoader = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 247" {...props}>
    <g fill="#497BBB">
      <path d="m165.759 82.951 58.343 108.03-19.343 28.728H51.344l-19.478-29.302L90.201 82.95zm16.047-26.903H74.194L.493 191.81l36.431 54.802h182.152l36.431-54.102z" />
