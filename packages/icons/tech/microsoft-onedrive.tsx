...
const SvgMicrosoftOnedrive = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 165" {...props}>
    <path
      fill="#0364B8"
...
export default SvgMicrosoftOnedrive
