...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path
      fill="#58595B"
      d="m28.539 49.627-2.041 10.207c18.708 6.291 36.395.166 45.751-16.158-13.778-9.522-26.535.17-43.71 5.951"
    />
    <linearGradient
      id={`b-${suffix}`}
      x1={324.268}
    ...
    <path fill={`url(#d-${suffix})`} d="M2.178 47.08c29.932-18.031 46.77-21.43 81.634-25-40.478 31.969-41.499 25-81.634 25" />
    <path fill="none" stroke="#4A4A4C" strokeWidth={0.5} d="M83.812 22.246 51.667 45.545" />
    <path fill="#231F20" d="M45.545 34.66c.34 3.744-.511-3.572 0 0" opacity={0.23} />
    <path fill="none" stroke="#A8ABAD" strokeWidth={0.5} d="m2.178 47.08 49.489-1.535" />
    <path
      fill="none"
      stroke="#F16922"
      strokeWidth={0.5}
    ...
    <path
      fill="#6D6E70"
      d="M41.076 33.844c.708-.25 1.384-.17 1.509.184.126.355-.344.846-1.052 1.096-.709.256-1.384.172-1.51-.184-.127-.352.344-.844 1.053-1.096"
    />
  </svg>
)}
