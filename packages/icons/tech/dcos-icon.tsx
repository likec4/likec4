...
const SvgDcosIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 201" {...props}>
    <defs>
      <linearGradient id="dcos-icon_svg__a" x1="0%" x2="100%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#7D58FF" />
        <stop offset="100%" stopColor="#FF007D" />
      </linearGradient>
    </defs>
    <path
      fill="url(#dcos-icon_svg__a)"
