...
const SvgConfluence = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 246" {...props}>
    <defs>
      <linearGradient id="Confluence_svg__a" x1="99.14%" x2="33.859%" y1="112.708%" y2="37.755%">
        <stop offset="18%" stopColor="#0052CC" />
        <stop offset="100%" stopColor="#2684FF" />
      </linearGradient>
      <linearGradient id="Confluence_svg__b" x1=".926%" x2="66.18%" y1="-12.582%" y2="62.306%">
        <stop offset="18%" stopColor="#0052CC" />
        <stop offset="100%" stopColor="#2684FF" />
      </linearGradient>
    </defs>
