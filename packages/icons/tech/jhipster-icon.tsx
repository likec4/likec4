...
const SvgJhipsterIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 104" {...props}>
    <path
      fill="#3474AB"
...
export default SvgJhipsterIcon
