...
const SvgPrettier = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256" {...props}>
    ...
    <rect width={24.381} height={12.19} x={158.476} y={219.429} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={60.952} height={12.19} x={85.333} y={219.429} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={60.952} height={12.19} x={195.048} y={219.429} fill="#D0D4D8" opacity={0.5} rx={5} />
    ...
    <rect width={36.571} height={12.19} x={170.667} y={170.667} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={36.571} height={12.19} x={219.429} y={170.667} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={48.762} height={12.19} x={207.238} y={146.286} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={48.762} height={12.19} x={207.238} y={24.381} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={36.571} height={12.19} x={219.429} y={121.905} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={36.571} height={12.19} x={219.429} y={48.762} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={24.381} height={12.19} x={231.619} y={73.143} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={24.381} height={12.19} x={231.619} y={97.524} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={121.905} height={12.19} x={134.095} y={195.048} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={36.571} height={12.19} x={85.333} y={195.048} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={73.143} height={12.19} x={182.857} y={243.81} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={85.333} height={12.19} x={85.333} y={243.81} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={48.762} height={12.19} x={85.333} y={73.143} fill="#D0D4D8" opacity={0.5} rx={5} />
    <rect width={48.762} height={12.19} x={85.333} y={97.524} fill="#D0D4D8" opacity={0.5} rx={5} />
  </svg>
)
