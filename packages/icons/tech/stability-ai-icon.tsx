...
const SvgStabilityAiIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 213" {...props}>
    <defs>
      <linearGradient id="stability-ai-icon_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#9D39FF" />
        <stop offset="100%" stopColor="#A380FF" />
      </linearGradient>
    </defs>
    <path
      fill="url(#stability-ai-icon_svg__a)"
...
export default SvgStabilityAiIcon
