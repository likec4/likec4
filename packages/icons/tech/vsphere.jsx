...
const SvgVsphere = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path
      fill="#78BD20"
      d="M67.7 125.7h40.1s15.8-.8 18-18V21.4s-1.1-17.3-19.1-19.1h-35l-5.3 5.3h39.7s12.6 1.6 14.2 14.2v84.8s.5 12.8-14 14H72.5z"
    />
    <g fill="#0091DA">
      <path d="M100.1 109.9s-.1 0 0 0H47.6c-6.5 0-8.8-5.8-9.1-8.9V46.8c0-7.3 6.3-9.5 9.6-9.6h.1l52.7.2c6.6 0 9 6 9.3 9.1v53.2c0 3-.9 5.5-2.8 7.3-2.8 2.8-6.7 2.9-7.3 2.9m-57.6-9.3c.1.8.9 5.3 5.1 5.3h52.5c.1 0 2.8 0 4.6-1.7 1-1 1.5-2.5 1.5-4.4V46.9c-.1-.9-1-5.5-5.4-5.5l-52.6-.2c-.7 0-5.7.5-5.7 5.6z" />
