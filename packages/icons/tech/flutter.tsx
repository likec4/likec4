...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <linearGradient id={`a-${suffix}`} x1={59.365} x2={86.825} y1={116.36} y2={99.399} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#1b4e94" />
      <stop offset={0.63} stopColor="#1a5497" />
      <stop offset={1} stopColor="#195a9b" />
    </linearGradient>
    <path fill={`url(#a-${suffix})`} d="m61.6 113.1 30.8-8.4-10.8-10.8z" />
  </svg>
)}
