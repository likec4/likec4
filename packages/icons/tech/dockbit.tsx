...
const SvgDockbit = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 286" {...props}>
    <defs>
      <linearGradient id="dockbit_svg__a" x1="77.041%" x2="22.841%" y1="13.184%" y2="87.539%">
        <stop offset="0%" stopColor="#7236DC" />
        <stop offset="100%" stopColor="#3F37AE" />
      </linearGradient>
    </defs>
    <path
      fill="url(#dockbit_svg__a)"
