...
const SvgGoogleOptimize = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 264" {...props}>
    <path
      fill="#B366F6"
    ...
    />
    <circle cx={35.94} cy={131.538} r={35.94} fill="#8430CE" />
    <path
      fill="#C58AF8"
...
export default SvgGoogleOptimize
