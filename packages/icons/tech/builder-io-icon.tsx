...
const SvgBuilderIoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 293" {...props}>
    <path
      fill="#18B4F4"
...
export default SvgBuilderIoIcon
