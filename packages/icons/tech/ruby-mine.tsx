...
return (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <linearGradient id={`a-${suffix}`} x1={65.05} x2={52.91} y1={60.03} y2={28.18} gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id={`b-${suffix}`} x1={41.93} x2={60.67} y1={14.45} y2={31.63} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#6b57ff" />
      <stop offset={1} stopColor="#fe2857" />
    </linearGradient>
    <linearGradient id={`c-${suffix}`} x1={3.92} x2={65.63} y1={19.88} y2={98.32} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#6b57ff" />
    ...
    />
    <path fill={`url(#b-${suffix})`} d="m100.596 47.482-53.48-31.695 53.48 62.683z" />
    <path
      fill={`url(#c-${suffix})`}
