...
const SvgCloudGpu = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
    <defs>
      <style>{'.Cloud-GPU_svg__cls-1{fill:#4285f4}'}</style>
    </defs>
    <g data-name="Product Icons">
      <path
        ...
        className="Cloud-GPU_svg__cls-1"
      />
      <path d="M12.83 7.54v3.58h1.96l-3.5 4.86v-3.63H9.22z" className="Cloud-GPU_svg__cls-1" />
    </g>
  </svg>
)
