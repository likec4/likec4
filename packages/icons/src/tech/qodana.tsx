...
const SvgQodana = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <linearGradient id="Qodana_svg__a" x1={-2.61} x2={101.85} y1={100.51} y2={85.49} gradientUnits="userSpaceOnUse">
      <stop offset={0.18} stopColor="#fc801d" />
      <stop offset={0.63} stopColor="#ff318c" />
    </linearGradient>
    <linearGradient id="Qodana_svg__b" x1={-17.85} x2={130.71} y1={-1.57} y2={108.84} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#ff318c" />
      <stop offset={0.4} stopColor="#b74af7" />
      <stop offset={0.87} stopColor="#ff318c" />
    </linearGradient>
    <linearGradient id="Qodana_svg__c" x1={-35.11} x2={129.64} y1={47.35} y2={8.71} gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#ff318c" />
