...
const SvgLivewire = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={128} height={128} {...props}>
    ...
    />
    <path
      d="M40.844 78.145v22.668c0 4.066-3.301 7.363-7.371 7.363a7.365 7.365 0 0 1-7.371-7.364V73.45c1.375-2.523 2.945-4.707 5.78-4.707 4.61 0 6.223 5.79 8.962 9.403Zm27.843 1.183v35.844a8.185 8.185 0 0 1-8.187 8.183c-4.523 0-8.191-3.664-8.191-8.183v-40.57c1.543-2.973 3.132-5.86 6.39-5.86 5.16 0 6.563 7.242 9.989 10.586Zm26.211-.66v26.023c0 4.067-3.3 7.364-7.37 7.364s-7.372-3.297-7.372-7.364V72.707c1.281-2.195 2.809-3.965 5.364-3.965 4.84 0 6.375 6.38 9.378 9.926m0 0"
      style={{
        fillRule: 'evenodd',
        fill: '#4e56a6',
        fillOpacity: 1
    ...
    />
    <path
      d="M97.273 88.984c13.676-20.332 14.028-42.879 1.059-67.652 9.613 9.844 15.547 23.348 15.547 38.25 0 8.61-1.98 16.75-5.508 23.992-2.004 2.91-3.531 6.5-7.61 6.5a5.95 5.95 0 0 1-3.488-1.09m0 0"
      style={{
        fillRule: 'evenodd',
        fill: '#e24ca6',
        fillOpacity: 1
    ...
    />
    <path
      d="M61.625 37.836c0 5.89-4.332 10.668-9.672 10.668-5.344 0-9.672-4.777-9.672-10.668s4.328-10.668 9.672-10.668c5.34 0 9.672 4.777 9.672 10.668m0 0"
      style={{
        fillRule: 'evenodd',
        fill: '#030776',
        fillOpacity: 1
    ...
    />
    <path
      d="M55.176 35.375c0 2.719-2.164 4.922-4.836 4.922s-4.836-2.203-4.836-4.922 2.164-4.922 4.836-4.922 4.836 2.203 4.836 4.922m0 0"
      style={{
        fillRule: 'evenodd',
        fill: '#fff',
        fillOpacity: 1
