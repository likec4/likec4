...
const SvgVisualStudioCodeVsCode = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <mask
      id="Visual-Studio-Code-(VS-Code)_svg__a"
      width={128}
      height={128}
      x={0}
      y={0}
    ...
    <g mask="url(#Visual-Studio-Code-(VS-Code)_svg__a)">
      <path
        fill="#0065A9"
      ...
      />
      <g filter="url(#Visual-Studio-Code-(VS-Code)_svg__b)">
        <path
          fill="#007ACC"
      ...
      <g filter="url(#Visual-Studio-Code-(VS-Code)_svg__c)">
        <path
          fill="#1F9CF0"
      ...
      <path
        fill="url(#Visual-Studio-Code-(VS-Code)_svg__d)"
        fillRule="evenodd"
    ...
    <defs>
      <filter
        id="Visual-Studio-Code-(VS-Code)_svg__b"
        width={144.744}
        height={113.408}
        x={-8.411}
        y={22.594}
      ...
      <filter
        id="Visual-Studio-Code-(VS-Code)_svg__c"
        width={56.667}
        height={144.007}
        x={79.667}
        y={-8.004}
      ...
      <linearGradient
        id="Visual-Studio-Code-(VS-Code)_svg__d"
        x1={63.922}
        x2={63.922}
        y1={0.33}
        y2={127.67}
