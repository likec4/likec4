...
const SvgBehance = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <defs>
      <linearGradient id="a" x1={64} x2={64} y1={2.16} y2={125.84} gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#005cff" />
        <stop offset={1} stopColor="#0047ad" />
      </linearGradient>
    </defs>
    <rect width={123.68} height={123.67} x={2.16} y={2.16} fill="url(#a)" rx={14.59} ry={14.59} />
    <path
      fill="#fff"
