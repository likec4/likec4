/// <reference types="../../../../app/src/likec4/_types.d.ts"/>
import { isString } from '@likec4/core'
import { zip } from 'rambdax'
import type { DiagramView, OriginalDiagramView } from '~likec4'

function commonPath(diagrams: OriginalDiagramView[], sep = '/') {
...
export function addDocPaths(diagrams: OriginalDiagramView[]): DiagramView[] {
