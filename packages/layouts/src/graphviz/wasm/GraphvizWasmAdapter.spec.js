...
import { computedAmazonView, computedCloud3levels, computedCloudView, computedIndexView, issue577_fail, issue577_valid, parsedModel as likec4model, } from '../__fixtures__';
...
describe('GraphvizWasmAdapter:', () => {
    ...
    it('layout projects view', async ({ expect }) => {
        ...
        const computedView = computeProjectsView([
            ...
            builder
                .model(({ el, rel }, _) => _(el('@projectD.c1'), rel('c1.sub', '@projectD.c1', {
                title: 'C -> D',
            })))
