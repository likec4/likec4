...
import { ACTOR_GAP, COLUMN_GAP, FIRST_STEP_OFFSET, MIN_ROW_HEIGHT, PORT_HEIGHT, STEP_LABEL_MARGIN, } from './const';
...
export class SequenceViewLayouter {
     ...
     */
    require(left, op, right = undefined) {
     ...
     */
    constraint(left, op, right = undefined, strength = kiwi.Strength.medium) {
        let operator;
        switch (op) {
            case '==':
    ...
    put(variable, strength = kiwi.Strength.required) {
