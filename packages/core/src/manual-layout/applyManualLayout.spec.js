...
function testApplyManualLayout(patches) {
    const { snapshot, snapshotNodes, snapshotEdges, layouted, layoutedNodes, layoutedEdges, } = prepareFixtures(patches);
