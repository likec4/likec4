...
export interface ComputeCtx<E extends Element<AnyAux>, C extends Connection<E, any>, M extends ComputeMemory<any>, Inc extends StageInclude<any>, Exc extends StageExclude<any>, Expr = unknown> {
    Element: E;
    Connection: C;
    Memory: M;
    StageInclude: Inc;
...
export type GenericCtx = ComputeCtx<any, Connection<any, any>, ComputeMemory<GenericCtx>, StageInclude<GenericCtx>, StageExclude<GenericCtx>, unknown>;
...
export interface StageInclude<T extends AnyCtx> extends Stage<T> {
     ...
     * @default 'both'
     */
    connectWithExisting(element: CtxElement<T> | Iterable<CtxElement<T>>, direction?: 'in' | 'out' | 'both'): boolean;
