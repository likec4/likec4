...
describe('findRelations', () => {
    ...
    const baseModel = specs
        .model(({ el }, _) => _(el('a').with(el('child1'), el('child2')), el('b').with(el('child1'), el('child2')), el('shopify'), el('webhook')))
        .views(({ view, $include }, _) => _(view('index', $include('*'))));
    const testFindRelationsOnModel = (model) => {
    ...
    it('should return single relationship properties including technology and description', () => {
        const model = baseModel
            .model(({ rel }, _) => _(rel('shopify', 'webhook', {
            title: 'requests',
    ...
    it('should return technology when all relationships have same technology', () => {
        const model = baseModel
            .model(({ rel }, _) => _(rel('a.child1', 'b.child1', {
            technology: 'REST',
