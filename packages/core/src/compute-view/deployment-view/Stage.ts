...
//   #excludedConnections = [] as DeploymentConnectionModel[]
...
//     this.#connections = mergeConnections([...this.#connections, ...connections])
...
//     }
//     for (const c of connections) {
//       this.#excludedConnections = mergeConnections([
//         ...this.#excludedConnections,
//         ...connections
//       ])
//     }
//     return this
