...
import { $include, computeNodesAndEdges } from './fixture';
...
describe('DirectRelationPredicate', () => {
    it('should include with all wildcards', () => {
        expectComputed($include('* -> *')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "global.email",
          "customer.instance",
    ...
    it('should include direct relation', () => {
        expectComputed($include('customer -> prod.eu')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    `);
        expectComputed($include('customer -> *')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    it('should include direct relations with instances and wildcards', () => {
        ...
        expectComputed($include('customer.instance -> *')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer.instance",
          "prod",
    ...
    `);
        expectComputed($include('* <-> prod')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    `);
        expectComputed($include('* <-> prod.eu.zone1.ui')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    it('should include direct relations with expand predicate', () => {
        expectComputed($include('customer'), // should be visible, but has no connections
        $include('prod.eu.zone1._ <-> prod.eu.zone2._')).toEqual({
            'Nodes': [
                'customer',
                'prod.eu.zone1',
                'prod.eu.zone1.ui',
        ...
        expectComputed($include('customer -> prod.eu._')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    `);
        expectComputed($include('customer'), $include('prod.eu.zone1._ <-> prod.eu.zone2._'), $include('prod.eu.zone2._')).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
