...
describe('DirectRelationPredicate', () => {
    it('should include direct relation if it matches condition', () => {
        expectComputed($include('customer -> prod.eu', { where: 'tag is #old' })).toMatchInlineSnapshot(`
      {
        "Nodes": [
          "customer",
          "prod",
    ...
    it('should not include direct relation if it does not match condition', () => {
        expectComputed($include('customer -> prod.eu', { where: 'tag is #next' })).toMatchInlineSnapshot(`
      {
        "Nodes": [],
        "edges": [],
      }
