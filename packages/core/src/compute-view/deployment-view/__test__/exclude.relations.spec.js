...
describe('Exclude RelationExpr', () => {
    it('should exclude inout', () => {
        expectComputed($include('customer'), $include('prod.eu.**'), $exclude({
            inout: {
                ref: {
    ...
    it('should exclude incoming', () => {
        expectComputed($include('customer'), $include('prod.eu._'), $include('prod.eu.zone1._'), $include('prod.eu.zone2._'), $exclude({
            incoming: {
                ref: {
                    model: 'cloud.backend.api',
                },
    ...
    it('should exclude outgoing', () => {
        expectComputed($include('customer'), $include('prod.eu.zone1._'), $include('prod.eu.zone2._'), $exclude({
            outgoing: {
                ref: {
    ...
    it('should exclude direct between expanded model and wildcard', () => {
        expectComputed($include('prod.eu.zone1.**'), $include('prod.eu._'), $exclude('prod.eu.zone2'), $exclude({
            source: {
                ref: {
                    model: 'cloud.backend',
                },
    ...
    it('should exclude direct between model and deployment', () => {
        expectComputed($include('prod.eu.zone1.**'), $include('prod.eu.zone2.**'), $exclude({
            source: {
                ref: {
