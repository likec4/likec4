  ...
  describe('deployed instance', () => {
    it('computed from summary or description field if defined', () => {
      const t = TestHelper.from(
        builder.clone().deployment(d =>
          d._(
            d.instanceOf('test.el1', 'el-with-summary', {
              summary: 'summary',
            }),
      ...
      const t = TestHelper.from(
        builder.clone().deployment(d =>
          d._(
            ...
            d.instanceOf('test.el3', 'el-with-description'),
            d.instanceOf('test.el4', 'el-with-description', {
              description: 'higher priority',
            }),
          )
        ),
