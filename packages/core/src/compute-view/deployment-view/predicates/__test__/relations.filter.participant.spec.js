...
describe('RelationPredicate', () => {
    ...
    describe('* -> * where participant is', () => {
        const t = TestHelper.from(builder.deployment((_, deploymentModel) => deploymentModel(_.node('a'), _.node('a.b'), _.node('a.b.c').with(_.instanceOf('cloud.ui')), _.node('a.b.d').with(_.instanceOf('api', 'cloud.backend.api', { tags: ['alpha'] })), _.node('a.b.d.e', { tags: ['alpha'] }).with(_.instanceOf('cloud.db')), _.rel('a.b.d.api', 'a.b.d.e'))));
        describe('model', () => {
            it('should exclude relation when porperties match', () => {
                t.expectComputedView($include('a.b.c.ui -> a.b.d.api'), $exclude('a.b.c.ui -> a.b.d.api', { where: 'source.tag is #next' })).toHave({
                    nodes: [],
                    edges: [],
                });
            });
            it('should exclude relation when porperties do not match', () => {
                t.expectComputedView($include('a.b.c.ui -> a.b.d.api'), $exclude('a.b.c.ui -> a.b.d.api', { where: 'source.tag is #alpha' })).toHave({
