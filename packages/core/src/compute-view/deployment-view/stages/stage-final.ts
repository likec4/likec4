...
export class StageFinal {
  static for(memory: Memory, includeAncestors: boolean) {
    return new StageFinal(memory, includeAncestors)
  }

  private constructor(
    protected readonly memory: Memory,
    protected readonly includeAncestors: boolean,
  ) {
  }
