...
export class StageFinal {
    ...
    step1CleanConnections(memory) {
        ...
        //   }
        // }
        const connections = pipe(memory.connections, 
        // Keep connections
        // - between leafs
        ...
        // }),
        cleanCrossBoundary, cleanRedundantRelationships);
    ...
    step2ProcessImplicits(memory) {
        ...
        const groupedByRelation = new DefaultMap(() => new Set());
        ...
        pipe(difference(implicits, snapshot), ifilter(e => e.isDeploymentNode()), toArray(), sortByFqnHierarchically, forEach((el) => {
