...
import { ancestorsFqn, commonAncestor, compareFqnHierarchically, hierarchyDistance, isAncestor, isDescendantOf, parentFqn, sortByFqnHierarchically, sortNaturalByFqn, sortParentsFirst, } from './fqn';
const el = (id) => ({ id });
...
describe('fqn utils', () => {
    ...
    describe('sortByFqnHierarchically', () => {
        it('should sort hierarchically', () => {
            expect(sortByFqnHierarchically([
                el('a.b'),
                el('a'),
                el('a.b.c'),
                el('a.c.a.b'),
