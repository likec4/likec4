...
describe('markdownToHtml', () => {
    ...
    it('should convert emphasis to HTML emphasis tags', () => {
        ...
        expect(markdownToHtml('***bold italic***')).toMatchInlineSnapshot(`"<p><em><strong>bold italic</strong></em></p>"`);
    });
    it('should convert links to HTML anchors', () => {
        expect(markdownToHtml('[link text](https://example.com)')).toMatchInlineSnapshot(`"<p><a href="https://example.com">link text</a></p>"`);
        expect(markdownToHtml('Visit [example](https://example.com) for more info')).toMatchInlineSnapshot(`"<p>Visit <a href="https://example.com">example</a> for more info</p>"`);
    });
