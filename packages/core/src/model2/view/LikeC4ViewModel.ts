...
export class LikeC4ViewModel<A extends AnyAux, V extends ProcessedView<A> = ProcessedView<A>> {
  ...
  readonly #includeElements = new Set<Aux.Strict.Fqn<A>>()
  readonly #includeDeployments = new Set<Aux.Strict.DeploymentFqn<A>>()
  ...
  public includesElement(elementId: Aux.Strict.Fqn<A>): boolean {
    return this.#includeElements.has(elementId)
  }

  public includesDeployment(deploymentId: Aux.Strict.DeploymentFqn<A>): boolean {
  ...
  public isElementView(): this is LikeC4ViewModel<A, ComputedElementView<A>> {
    return isNullish(this.$view.__) || this.$view.__ === 'element'
  }

  public isDeploymentView(): this is LikeC4ViewModel<A, ComputedDeploymentView<A>> {
    return !isNullish(this.$view.__) && this.$view.__ === 'deployment'
  }

  public isDynamicView(): this is LikeC4ViewModel<A, ComputedDynamicView<A>> {
    return !isNullish(this.$view.__) && this.$view.__ === 'dynamic'
  }
}
