...
describe('LikeC4ViewsGroup', () => {
    const model = Builder
        ...
        .model(({ el }, _) => _(el('customer'), el('cloud'), el('cloud.ui', {
        title: 'UI',
    })))
        .views(({ view }, _) => _(view('index'), view('b'), view('a'), view('cloud2-subview', 'One / Cloud 2 / Subview'), view('cloud2', 'One / Cloud 2'), view('cloud1', 'One / Cloud 1'), view('cloud1-subview', 'One / Cloud 1 / Subgroup / Subview')))
        .toLikeC4Model();
    ...
    describe('view folder (level 3)', () => {
        it('One/Cloud 1/Subgroup', ({ expect }) => {
            ...
            expect(folder.children).toEqual(new Set([
