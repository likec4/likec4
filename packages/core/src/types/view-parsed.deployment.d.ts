...
import type { AnyExcludePredicate, AnyIncludePredicate, AnyViewRuleStyle, BaseParsedViewProperties, ViewRuleAutoLayout } from './view-common';
/**
...
export type DeploymentViewPredicate<A extends AnyAux = Unknown> = DeploymentViewIncludePredicate<A> | DeploymentViewExcludePredicate<A>;
