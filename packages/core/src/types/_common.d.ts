import type { IsAny, KeysOfUnion, Simplify, UnionToIntersection } from 'type-fest';
 ...
 */
export type NTuple<T, N extends number, Result extends Array<unknown> = []> = Result['length'] extends N ? Result : NTuple<T, N, [...Result, T]>;
 ...
 */
export declare function exact<Expected, T extends ExactObject<Expected, T>>(a: T): Expected;
export {};
