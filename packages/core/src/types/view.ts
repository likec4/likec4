...
export type ViewRulePredicate<A extends AnyAux = Aux.Any> =
  | {
...
export interface ViewRuleStyle<A extends AnyAux = Aux.Any> {
...
export type ViewRuleStyleOrGlobalRef<A extends AnyAux = Aux.Any> = ViewRuleStyle<A> | ViewRuleGlobalStyle
...
export interface ViewRuleGroup<A extends AnyAux = Aux.Any> {
...
export type ViewRule<A extends AnyAux = Aux.Any> =
  | ViewRulePredicate<A>
...
export interface UnscopedElementView<A extends AnyAux = Aux.Any> extends BasicView<A> {
  readonly __: 'element'
  readonly rules: ViewRule<A>[]
  viewOf?: never
  extends?: never
}
export interface ScopedElementView<A extends AnyAux = Aux.Any> extends BasicView<A> {
  readonly __: 'element'
  readonly rules: ViewRule<A>[]
...
export interface ExtendsElementView<A extends AnyAux = Aux.Any> extends BasicView<A> {
  readonly __: 'element'
  readonly rules: ViewRule<A>[]
  readonly viewOf?: Aux.Strict.Fqn<A>
  readonly extends: Aux.Strict.ViewId<A>
}
export type ElementView<A extends AnyAux = Aux.Any> =
  | UnscopedElementView<A>
  | ScopedElementView<A>
  | ExtendsElementView<A>

export interface DynamicViewStep<A extends AnyAux = Aux.Any> {
...
export interface DynamicViewParallelSteps<A extends AnyAux = Aux.Any> {
  readonly __parallel: DynamicViewStep<A>[]
}

export type DynamicViewStepOrParallel<A extends AnyAux = Aux.Any> = Simplify<
  MergeExclusive<
    DynamicViewStep<A>,
...
export type DynamicViewIncludeRule<A extends AnyAux = Aux.Any> = {
  include: ModelFqnExpr.Any<A>[]
}

export type DynamicViewRule<A extends AnyAux = Aux.Any> =
  | DynamicViewIncludeRule<A>
  | ViewRuleGlobalPredicateRef
  | ViewRuleStyle<A>
  | ViewRuleGlobalStyle
  | ViewRuleAutoLayout
export interface DynamicView<A extends AnyAux = Aux.Any> extends BasicView<A> {
  readonly __: 'dynamic'
...
export type DeploymentViewRulePredicate<A extends AnyAux = Aux.Any> =
  | {
...
export type DeploymentViewRuleStyle<A extends AnyAux = Aux.Any> = {
  targets: FqnExpr<A>[]
  notation?: string
  style: ElementStyle & {
    color?: Color
...
export type DeploymentViewRule<A extends AnyAux = Aux.Any> =
  | DeploymentViewRulePredicate<A>
  | ViewRuleAutoLayout
  | DeploymentViewRuleStyle<A>

export interface DeploymentView<A extends AnyAux = Aux.Any> extends BasicView<A> {
  readonly __: 'deployment'
  readonly rules: DeploymentViewRule<A>[]
}

export type LikeC4View<A extends AnyAux = Aux.Any> =
  | ScopedElementView<A>
  | ExtendsElementView<A>
  | UnscopedElementView<A>
  | DeploymentView<A>
...
export interface ComputedNode<A extends AnyAux = Aux.Any> {
...
export interface ComputedEdge<A extends AnyAux = Aux.Any> {
...
export interface ComputedElementView<A extends AnyAux = Aux.Any>
...
export interface ComputedDynamicView<A extends AnyAux = Aux.Any>
...
export interface ComputedDeploymentView<A extends AnyAux = Aux.Any>
...
export type ComputedView<A extends AnyAux = Aux.Any> =
...
export interface DiagramNode<A extends AnyAux = Aux.Any> extends ComputedNode<A> {
  width: number
  height: number
...
export interface DiagramEdge<A extends AnyAux = Aux.Any> extends ComputedEdge<A> {
  // Bezier points
...
export interface DiagramView<A extends AnyAux = Aux.Any>
...
export type ProcessedView<A extends AnyAux = Aux.Any> = ComputedView<A> | DiagramView<A>
