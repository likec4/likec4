...
import type { Any, AnyComputed, AnyLayouted, AnyParsed, UnknownComputed, UnknownLayouted, UnknownParsed } from './_aux';
...
export type AuxFromLikeC4ModelData<D> = D extends BaseLikeC4ModelData<infer A extends Any> ? IsAny<A> extends true ? never : A : never;
...
export type LikeC4ModelData<A extends Any> = ParsedLikeC4ModelData<A> | ComputedLikeC4ModelData<A> | LayoutedLikeC4ModelData<A>;
export {};
