...
import type { BorderStyle, Color, ColorLiteral, CustomColorDefinitions, ElementShape, IconPosition, RelationshipArrowType, RelationshipLineType, ShapeSize, SpacingSize, TextSize, ThemeColor } from '../styles/types';
 ...
 */
export declare function isTagColorSpecified(spec: string | TagSpecification): spec is {
    color: ColorLiteral;
};
