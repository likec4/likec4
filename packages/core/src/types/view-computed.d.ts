...
import type { Color, ElementShape, RelationshipArrowType, RelationshipLineType } from '../styles/types';
...
import type { BaseViewProperties, RankValue, ViewAutoLayout, ViewManualLayout, ViewWithHash, ViewWithNotation } from './view-common';
import type { DynamicViewDisplayVariant } from './view-parsed.dynamic';
export type ComputedNodeStyle = Simplify<ElementStyle & {
    icon?: never;
    shape?: never;
    color?: never;
}>;
export interface ComputedNode<A extends AnyAux = AnyAux> extends aux.WithTags<A>, aux.WithOptionalLinks {
    id: scalar.NodeId;
