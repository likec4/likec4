...
export type ExtractOnStage<T, S extends ModelStage> = Extract<T, {
    [_stage]: S;
}>;
export declare function isOnStage<T extends {
    [_stage]: ModelStage;
 ...
 * @internal
 */
export declare const _stage = "_stage";
