...
4. ##### Create first diagram    
    ...
    ![landscape view](/dsl/../assets/getting-started/01.png)
...
4. ##### Add more views
    ...
    ![saas view](/dsl/../assets/getting-started/02.png)
...
4. ##### Enrich model
    ...
    ![saas view after changes](/dsl/../assets/getting-started/03.png)
...
4. ##### Add changes
    ...
    ![landscape view after changes](/dsl/../assets/getting-started/04.png)

    View `saas`:

    ![saas view after changes](/dsl/../assets/getting-started/05.png)
