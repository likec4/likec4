...
Include elements of only they have outgoing relationships to visible elements:
...
For example, include nested elements of `cloud`, that have any relationships with visible elements:
...
Include relationships of specific direction and the elements:
...
Include any relationships between elements:
