...
- **Export:** Add `likec4StrokeColor` on vertex when element has stroke color; add `likec4Metadata` on edge when relationship has metadata. Round-trip comment parsing for layout/stroke/waypoints, used by Playground/CLI for round-trip export.
